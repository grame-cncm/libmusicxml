...
void msr2guidoRegularOahHandler::createRegularHandlerGroups ()
{
#ifdef TRACING_IS_ENABLED
#ifdef ENFORCE_TRACE_OAH
  gLogStream <<
...
void msr2guidoRegularOahHandler::createInformationsRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::createFilesRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::createOahRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::createWarningAndErrorsRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::createInputRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::createPresentationRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::createPartsRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::createStavesRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::createVoicesRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::createClefsRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::createKeysRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::createTimesRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::createMeasuresRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::createRestsRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::createNotesRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::creatBeamsRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::createArticulationsRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::createOrnamentsRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::createGraceNotesRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::createChordsRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::createTiesRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::createSlursRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::createLigaturesRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::createDynamicsRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::createWedgesRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::createTupletsRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::createLyricsRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::createHarmoniesRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::createFiguredBassesRegularGroup ()
{
  // group
...
void msr2guidoRegularOahHandler::createOutputRegularGroup ()
{
  // group
...
//______________________________________________________________________________
void msr2guidoRegularOahHandler::checkOptionsAndArgumentsFromArgcAndArgv () const
{
#ifdef TRACING_IS_ENABLED
...
//______________________________________________________________________________
void msr2guidoRegularOahHandler::print (ostream& os) const
{
  const unsigned int fieldWidth = 27;

  os <<
    "msr2guidoRegularOahHandler '" << fHandlerHeader << "':" <<
    endl;
...
ostream& operator<< (ostream& os, const S_msr2guidoRegularOahHandler& elt)
{
  elt->print (os);
  return os;
}
