...
% Generated by xml2ly 0.93 from "chords/Chords.xml"
% on Monday 2020-03-30 @ 10:11:41 CEST

% The translation command line was:
%   xml2ly '-xi' '-aofn' '-dmsr' '-dpg' '--dlpsr' '-abn' '-lpcd' '-rbracks' '-mssp' '1cm' '-loop' 'chords/Chords.xml' '-t=msrv'
% or, with long option names:
%  xml2ly chords/Chords.xml -xml2ly-infos -auto-output-file-name -display-msr -display-partgroups -display-lpsr -all-bar-numbers -lilypond-compile-date -repeat-brackets -markup-system-spacing.padding '1 cm' -loop-to-musicxml -trace-msr-visitors
% or, with short option names:
%   xml2ly chords/Chords.xml -xi -aofn -dmsr -dpg -dlpsr -abn -lpcd -rbracks -mssp '1 cm' -loop -tmsrv
...
Part_POne_Staff_One_Voice_One = \absolute {
  ...
  \clef "treble"
  <c'' g'' e'' bes''! >8 -! -\p r%{2%} r%{2%}2. | % 2
  \barNumberCheck #2
  <a' c'' e'' a'' >2 -\f <b' d'' f'' > -\staccato -_ | % 3
  \barNumberCheck #3
}
