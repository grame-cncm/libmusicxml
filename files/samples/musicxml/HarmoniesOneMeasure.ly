...
% Generated by xml2ly 0.93 from "harmonies/HarmoniesOneMeasure.xml"
% on Tuesday 2020-02-11 @ 16:43:27 CET

% The translation command line was:
%   xml2ly '-xi' '-aofn' '-dmsr' '-dpg' '--dlpsr' '-abn' '-lpcd' '-rbracks' '-mssp' '1cm' 'harmonies/HarmoniesOneMeasure.xml' '-t=harms,pim' '-iln' '-t=mxmltv,meas' '-dov'
% or, with long option names:
%  xml2ly harmonies/HarmoniesOneMeasure.xml -xml2ly-infos -auto-output-file-name -display-msr -display-partgroups -display-lpsr -all-bar-numbers -lilypond-compile-date -repeat-brackets -markup-system-spacing.padding '1 cm' -trace-harmonies -trace-positions-in-measures -input-line-numbers -trace-musicxml-tree-visitors -trace-measures -display-options-values
% or, with short option names:
%   xml2ly harmonies/HarmoniesOneMeasure.xml -xi -aofn -dmsr -dpg -dlpsr -abn -lpcd -rbracks -mssp '1 cm' -tharms -tpim -iln -tmxmltv -tmeas -dov
...
Part_POne_HARMONY_Staff_Voice_Eleven_HARMONY = \chordmode {
  ...
  \clef "treble"
  c4:m %{ line 87 %} f8:m7 %{ line 103 %} s%{44%} %{ line 131 %} g4:maj7 %{ line 131 %} cis:aug/gis %{ line 147 %} | % 1
  \barNumberCheck #2
}
