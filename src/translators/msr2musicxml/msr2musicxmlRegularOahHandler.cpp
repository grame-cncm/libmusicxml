...
S_msr2musicxmlRegularOahHandler msr2musicxmlRegularOahHandler::create (
              ...
              insiderOahHandler)
{
  ...
  msr2musicxmlRegularOahHandler* o = new
...
msr2musicxmlRegularOahHandler::msr2musicxmlRegularOahHandler (
  string      executableName,
  string      handlerHeader,
  S_msr2musicxmlInsiderOahHandler
              insiderOahHandler)
...
void msr2musicxmlRegularOahHandler::createRegularHandlerGroups ()
{
#ifdef TRACING_IS_ENABLED
#ifdef ENFORCE_TRACE_OAH
  gLogStream <<
...
void msr2musicxmlRegularOahHandler::createInformationsRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::createFilesRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::createOahRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::createWarningAndErrorsRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::createInputRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::createPresentationRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::createPartsRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::createStavesRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::createVoicesRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::createClefsRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::createKeysRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::createTimesRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::createMeasuresRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::createRestsRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::createNotesRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::creatBeamsRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::createArticulationsRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::createOrnamentsRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::createGraceNotesRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::createChordsRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::createTiesRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::createSlursRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::createLigaturesRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::createDynamicsRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::createWedgesRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::createTupletsRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::createLyricsRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::createHarmoniesRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::createFiguredBassesRegularGroup ()
{
  // group
...
void msr2musicxmlRegularOahHandler::createOutputRegularGroup ()
{
  // group
...
//______________________________________________________________________________
void msr2musicxmlRegularOahHandler::checkOptionsAndArgumentsFromArgcAndArgv () const
{
#ifdef TRACING_IS_ENABLED
...
//______________________________________________________________________________
void msr2musicxmlRegularOahHandler::print (ostream& os) const
{
  const unsigned int fieldWidth = 27;

  os <<
    "msr2musicxmlRegularOahHandler '" << fHandlerHeader << "':" <<
    endl;
...
ostream& operator<< (ostream& os, const S_msr2musicxmlRegularOahHandler& elt)
{
  elt->print (os);
  return os;
}
