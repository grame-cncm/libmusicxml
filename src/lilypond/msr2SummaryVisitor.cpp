...
/* JMI
void msr2SummaryVisitor::msrMusicXMLWarning (
  string message)
{
  musicXMLWarning (
...
void msr2SummaryVisitor::msrMusicXMLError (
  string message)
{
  musicXMLError (
    gCurrentMusicXMLLocation,
...
void msr2SummaryVisitor::msrInternalError (
  string message)
{
  internalError (
    gCurrentMusicXMLLocation,
...
//________________________________________________________________________
S_msrScore
msr2SummaryVisitor::buildMsrScoreFromXMLElementTree (
...
//________________________________________________________________________
S_msrPartgroup msr2SummaryVisitor::createImplicitMSRPartgroup (
  int inputLineNumber)
{
  /*
  ...
  */
  ...
  return partgroup;
} // msr2SummaryVisitor::createImplicitMSRPartgroup ()

//________________________________________________________________________
void msr2SummaryVisitor::visitStart (S_part_list& elt)
{
  if (fTranslationSettings->fTrace)
    cerr << idtr <<
...
void msr2SummaryVisitor::visitEnd (S_part_list& elt)
{
  idtr--;
...
S_msrPartgroup msr2SummaryVisitor::fetchPartgroupInThisVisitor (
  int partGroupNumber)
{
...
void msr2SummaryVisitor::visitStart (S_part_group& elt)
{  
  fCurrentPartgroupNumber =
...
void msr2SummaryVisitor::visitStart (S_group_name& elt)
{
  fCurrentPartgroupName = elt->getValue();
}

void msr2SummaryVisitor::visitStart (S_group_abbreviation& elt)
{
  fCurrentPartgroupAbbreviation = elt->getValue ();
}

void msr2SummaryVisitor::visitStart (S_group_symbol& elt)
{
...
void msr2SummaryVisitor::visitStart ( S_group_barline& elt)
{
  fCurrentPartgroupBarline = elt->getValue ();
}

void msr2SummaryVisitor::showPartgroupsData (string context)
{    
...
void msr2SummaryVisitor::handlePartgroupStart (
  int                               inputLineNumber,
...
void msr2SummaryVisitor::handlePartgroupStop (int inputLineNumber)
{
...
void msr2SummaryVisitor::visitEnd (S_part_group& elt)
{
  if (fTranslationSettings->fTrace)
    cerr << idtr <<
...
//________________________________________________________________________
void msr2SummaryVisitor::visitStart (S_score_part& elt)
{
...
void msr2SummaryVisitor::visitStart (S_part_name& elt)
{
  fCurrentPartName = elt->getValue ();
}

void msr2SummaryVisitor::visitStart (S_part_abbreviation& elt)
{
  fCurrentPartAbbreviation = elt->getValue ();
}

void msr2SummaryVisitor::visitStart (S_instrument_name& elt)
{
  fCurrentPartInstrumentName = elt->getValue(); // jMI
}

void msr2SummaryVisitor::visitEnd (S_score_part& elt)
{
  if (fTranslationSettings->fTrace)
    cerr << idtr <<
...
//________________________________________________________________________
void msr2SummaryVisitor::visitStart (S_part& elt)
{
...
void msr2SummaryVisitor::visitEnd (S_part& elt)
{
  idtr--;
}

//______________________________________________________________________________
void msr2SummaryVisitor::visitStart ( S_divisions& elt ) 
{
...
void msr2SummaryVisitor::visitStart ( S_key& elt ) {
...
void msr2SummaryVisitor::visitStart ( S_fifths& elt )
  { fCurrentFifths = (int)(*elt); }
  
void msr2SummaryVisitor::visitStart ( S_mode& elt )
  { fCurrentMode = elt->getValue(); }

void msr2SummaryVisitor::visitStart ( S_cancel& elt )
  { fCurrentCancel = (int)(*elt); }

void msr2SummaryVisitor::visitEnd ( S_key& elt ) 
{    
  // create msrKey
  S_msrKey
    key =
...
//______________________________________________________________________________
void msr2SummaryVisitor::visitStart ( S_time& elt )
{  
  /*
    The optional number attribute refers to staff numbers,
...
void msr2SummaryVisitor::visitStart ( S_beats& elt )
{ fCurrentTimeBeats = (int)(*elt); }
  
void msr2SummaryVisitor::visitStart ( S_beat_type& elt )
  { fCurrentTimeBeatType = (int)(*elt); }
 
void msr2SummaryVisitor::visitStart ( S_senza_misura& elt )
  { fCurrentTimeSenzaMisura = true; }

void msr2SummaryVisitor::visitEnd ( S_time& elt ) 
{
  S_msrTime
    time =
      msrTime::create (
...
//______________________________________________________________________________
void msr2SummaryVisitor::visitStart ( S_clef& elt )
{ 
  // The optional number attribute refers to staff numbers.
  // If absent (0), apply to all part staves.
...
void msr2SummaryVisitor::visitStart ( S_clef_octave_change& elt )
  { fCurrentClefOctaveChange = (int)(*elt); }
  
void msr2SummaryVisitor::visitStart ( S_line& elt )
  { fCurrentClefLine = (int)(*elt); }
  
void msr2SummaryVisitor::visitStart ( S_sign& elt )
  { fCurrentClefSign = elt->getValue(); }

void msr2SummaryVisitor::visitEnd ( S_clef& elt ) 
{  
  S_msrClef
    clef =
      msrClef::create (
...
//________________________________________________________________________
void msr2SummaryVisitor::visitStart (S_direction& elt)
{
/*
...
void msr2SummaryVisitor::visitStart (S_direction_type& elt)
{
...
void msr2SummaryVisitor::visitStart (S_words& elt)
{
  fCurrentDirectionWords = elt->getValue ();
}

void msr2SummaryVisitor::visitEnd (S_direction& elt)
{
  fOnGoingDirection = false;
}

//________________________________________________________________________
void msr2SummaryVisitor::visitStart (S_staves& elt)
{
...
void msr2SummaryVisitor::visitStart (S_staff& elt)
{
  /*
        <note>
        <pitch>
...
//________________________________________________________________________
void msr2SummaryVisitor::visitStart (S_voice& elt )
{
  /*
        <note>
        <pitch>
...
//________________________________________________________________________
void msr2SummaryVisitor::visitStart (S_backup& elt )
{
/*
...
void msr2SummaryVisitor::visitEnd (S_backup& elt )
{
  if (fTranslationSettings->fTrace)
    cerr << idtr <<
...
//______________________________________________________________________________
void msr2SummaryVisitor::visitStart ( S_forward& elt )
{
  /*
         <forward>
...
void msr2SummaryVisitor::visitEnd ( S_forward& elt )
{
  // change staff
...
//________________________________________________________________________
void msr2SummaryVisitor::visitStart ( S_metronome& elt )
{
...
void msr2SummaryVisitor::visitEnd ( S_metronome& elt )
{ 
...
void msr2SummaryVisitor::visitStart ( S_beat_unit& elt )
{ 
...
void msr2SummaryVisitor::visitStart ( S_beat_unit_dot& elt )
  { fCurrentBeat.fDots++; }
  
void msr2SummaryVisitor::visitStart ( S_per_minute& elt )
  { fPerMinute = (int)(*elt); }


//________________________________________________________________________
void msr2SummaryVisitor::visitStart (S_tied& elt )
{
...
void msr2SummaryVisitor::visitStart (S_slur& elt )
{
...
//________________________________________________________________________
void msr2SummaryVisitor::visitStart (S_lyric& elt )
{ 
...
void msr2SummaryVisitor::visitStart ( S_syllabic& elt )
{
...
void msr2SummaryVisitor::visitEnd ( S_text& elt ) 
{
...
void msr2SummaryVisitor::visitEnd ( S_elision& elt ) 
{
  fCurrentElision = true;
}

void msr2SummaryVisitor::visitEnd ( S_lyric& elt )
{
...
//________________________________________________________________________
void msr2SummaryVisitor::visitStart (S_measure& elt)
{
...
//______________________________________________________________________________
void msr2SummaryVisitor::visitStart ( S_print& elt ) 
{
...
//______________________________________________________________________________
void msr2SummaryVisitor::visitStart ( S_barline& elt ) 
{
...
void msr2SummaryVisitor::visitStart ( S_bar_style& elt ) 
{
...
void msr2SummaryVisitor::visitStart ( S_repeat& elt ) 
{
...
void msr2SummaryVisitor::visitStart ( S_ending& elt ) 
{
...
void msr2SummaryVisitor::visitEnd ( S_barline& elt ) 
{
 /*
  *       <barline location="right">
        <bar-style>light-heavy</bar-style>
...
//______________________________________________________________________________
void msr2SummaryVisitor::visitStart ( S_note& elt ) 
{
  //  cerr << "--> msr2SummaryVisitor::visitStart ( S_note& elt ) " << endl;
...
//______________________________________________________________________________
void msr2SummaryVisitor::visitStart ( S_step& elt )
{
...
void msr2SummaryVisitor::visitStart ( S_alter& elt)
{
  fMusicXMLNoteData.fMusicXMLAlteration = (int)(*elt);
}

void msr2SummaryVisitor::visitStart ( S_octave& elt)
{
  fMusicXMLNoteData.fMusicXMLOctave = (int)(*elt);
}

void msr2SummaryVisitor::visitStart ( S_duration& elt )
{
...
//  cerr << "=== msr2SummaryVisitor::visitStart ( S_duration& elt ), fCurrentMusicXMLDuration = " << fCurrentMusicXMLDuration << endl; JMI
}

void msr2SummaryVisitor::visitStart ( S_dot& elt )
{
  fMusicXMLNoteData.fMusicXMLDotsNumber++;
}
       
void msr2SummaryVisitor::visitStart ( S_type& elt )
{
  fCurrentNoteType=elt->getValue();
}

void msr2SummaryVisitor::visitStart ( S_stem& elt )
{
...
void msr2SummaryVisitor::visitStart ( S_beam& elt )
{
/*
...
//______________________________________________________________________________
void msr2SummaryVisitor::visitStart ( S_staccato& elt )
{
  S_msrArticulation
    articulation =
...
void msr2SummaryVisitor::visitStart ( S_staccatissimo& elt )
{
  S_msrArticulation
    articulation =
      msrArticulation::create (
...
void msr2SummaryVisitor::visitStart ( S_fermata& elt )
{
...
//______________________________________________________________________________
void msr2SummaryVisitor::visitStart( S_f& elt)
{        
  S_msrDynamics
    dyn =
      msrDynamics::create (
...
void msr2SummaryVisitor::visitStart( S_ff& elt)
{        
  S_msrDynamics
    dyn =
      msrDynamics::create (
...
void msr2SummaryVisitor::visitStart( S_fff& elt)
{        
  S_msrDynamics
    dyn =
      msrDynamics::create (
...
void msr2SummaryVisitor::visitStart( S_ffff& elt)
{        
  S_msrDynamics
    dyn =
      msrDynamics::create (
...
void msr2SummaryVisitor::visitStart( S_fffff& elt)
{        
  S_msrDynamics
    dyn =
      msrDynamics::create (
...
void msr2SummaryVisitor::visitStart( S_ffffff& elt)
{        
  S_msrDynamics
    dyn =
      msrDynamics::create (
...
void msr2SummaryVisitor::visitStart( S_p& elt)
{        
  S_msrDynamics
    dyn =
      msrDynamics::create (
...
void msr2SummaryVisitor::visitStart( S_pp& elt)
{        
  S_msrDynamics
    dyn =
      msrDynamics::create (
...
void msr2SummaryVisitor::visitStart( S_ppp& elt)
{        
  S_msrDynamics
    dyn =
      msrDynamics::create (
...
void msr2SummaryVisitor::visitStart( S_pppp& elt)
{        
  S_msrDynamics
    dyn =
      msrDynamics::create (
...
void msr2SummaryVisitor::visitStart( S_ppppp& elt)
{        
  S_msrDynamics
    dyn =
      msrDynamics::create (
...
void msr2SummaryVisitor::visitStart( S_pppppp& elt)
{        
  S_msrDynamics
    dyn =
      msrDynamics::create (
...
//______________________________________________________________________________
void msr2SummaryVisitor::visitStart ( S_wedge& elt )
{
...
//______________________________________________________________________________
void msr2SummaryVisitor::visitStart ( S_grace& elt )
{
  fMusicXMLNoteData.fMusicXMLNoteIsAGraceNote = true;;
}
       
//______________________________________________________________________________
void msr2SummaryVisitor::visitStart ( S_chord& elt)
{
  fMusicXMLNoteData.fMusicXMLNoteBelongsToAChord = true;
}

//______________________________________________________________________________
void msr2SummaryVisitor::visitStart ( S_actual_notes& elt )
{
  fCurrentActualNotes = (int)(*elt);
}

void msr2SummaryVisitor::visitStart ( S_normal_notes& elt )
{
  fCurrentNormalNotes = (int)(*elt);
}

void msr2SummaryVisitor::visitStart ( S_normal_type& elt )
{
  fCurrentNormalNoteType = elt->getValue();
}

void msr2SummaryVisitor::visitStart ( S_tuplet& elt )
{
  ...
  /* JMI
  cerr <<
    "msr2SummaryVisitor::visitStart ( S_tuplet, fCurrentTupletNumber = " <<
...
//______________________________________________________________________________
void msr2SummaryVisitor::visitStart ( S_rest& elt)
{
  /*
        <note>
        <rest/>
...
*/
  //  cerr << "--> msr2SummaryVisitor::visitStart ( S_rest& elt ) " << endl;
  fMusicXMLNoteData.fMusicXMLStepIsARest = true;
}

//______________________________________________________________________________
void msr2SummaryVisitor::visitStart ( S_display_step& elt)
{
...
void msr2SummaryVisitor::visitStart ( S_display_octave& elt)
{
  fDisplayOctave = (int)(*elt);
}

void msr2SummaryVisitor::visitEnd ( S_unpitched& elt)
{
/*
        <unpitched>
...
//______________________________________________________________________________
S_msrChord msr2SummaryVisitor::createChordFromCurrentNote ()
{
  if (fTranslationSettings->fDebug)
    cerr << idtr <<
...
//______________________________________________________________________________
void msr2SummaryVisitor::createTupletFromItsecondNote (S_msrNote secondNote)
{
...
void msr2SummaryVisitor::finalizeTuplet (S_msrNote note) {
...
void msr2SummaryVisitor::attachPendingDynamicsAndWedgesToNote (
  S_msrNote note)
{
...
//______________________________________________________________________________
void msr2SummaryVisitor::visitEnd ( S_note& elt )
{
  /*
...
//  if (true || fTranslationSettings->fDebug)
  ...
  fOnGoingNote = false;
} // msr2SummaryVisitor::visitEnd ( S_note& elt )

void msr2SummaryVisitor::handleStandaloneNoteOrRest (
  S_msrNote newNote)
{
...
void msr2SummaryVisitor::handleNoteBelongingToAChord (
  S_msrNote newNote)
{
  if (fMusicXMLNoteData.fMusicXMLStepIsARest)
    msrMusicXMLError (
...
void msr2SummaryVisitor::handleNoteBelongingToATuplet (
  S_msrNote newNote)
{
  fMusicXMLNoteData.fMusicXMLTupletMemberNoteType =
    fCurrentNoteType;
...
void msr2SummaryVisitor::handleLyricsText (
  int inputLineNumber)
{
//  if (true || fTranslationSettings->fDebug) {
  if (fTranslationSettings->fDebug) {
