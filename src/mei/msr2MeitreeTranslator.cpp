...
msr2MeitreeTranslator::msr2MeitreeTranslator (
  ostream&   os,
  S_msrScore mScore)
    : fLogOutputStream (os)
{
...
//________________________________________________________________________
void msr2MeitreeTranslator::buildMeitreeFromMsrScore ()
{
  if (fVisitedMsrScore) {
...
string msr2MeitreeTranslator::msrLengthAsTenths (
  msrLength length)
{
...
string msr2MeitreeTranslator::S_msrLengthAsTenths (
  S_msrLength length)
{
...
//______________________________________________________________________________
void msr2MeitreeTranslator::populatePageMargins (
  Sxmlelement       elem,
...
void msr2MeitreeTranslator::appendPageMarginsToScoreDefaultsPageLayout (
  S_msrMarginsGroup marginsGroup)
{
...
//______________________________________________________________________________
void msr2MeitreeTranslator::populateSystemMargins (
  Sxmlelement       elem,
...
void msr2MeitreeTranslator::appendSystemMarginsToScoreDefaultsSystemLayout (
  S_msrSystemLayout systemLayout)
{
  // JMI
}
...
//______________________________________________________________________________
string msr2MeitreeTranslator::msrPlacementKindAsMusicXMLString (
...
//______________________________________________________________________________
string msr2MeitreeTranslator::msrSpannerTypeKindAsMusicXMLString (
...
//________________________________________________________________________
void msr2MeitreeTranslator::appendToScoreWork (
  Sxmlelement elem)
{
...
//________________________________________________________________________
void msr2MeitreeTranslator::appendToScoreIdentification (
  Sxmlelement elem)
{
...
void msr2MeitreeTranslator::appendToScoreIdentificationEncoding (
  Sxmlelement elem)
{
...
//________________________________________________________________________
void msr2MeitreeTranslator::appendToScoreDefaults (
  Sxmlelement elem)
{
...
void msr2MeitreeTranslator::appendToScoreDefaultsPageLayout (
  Sxmlelement elem)
{
...
//________________________________________________________________________
void msr2MeitreeTranslator::appendToMeasureDirection (
  Sxmlelement      elem,
  msrPlacementKind placementKind)
{
  if (gMsr2MeitreeOah->fMusicXMLComments) {
...
//________________________________________________________________________
void msr2MeitreeTranslator::appendNoteToMeasure (
  S_msrNote   note,
  Sxmlelement elem)
{
#ifdef TRACE_OAH
...
void msr2MeitreeTranslator::appendOtherToMeasure (
  Sxmlelement elem)
{
#ifdef TRACE_OAH
  int inputLineNumber =
...
//________________________________________________________________________
void msr2MeitreeTranslator::appendToNoteNotations (
  Sxmlelement      elem,
  msrPlacementKind placementKind)
{
...
void msr2MeitreeTranslator::appendToNoteNotationsOrnaments (
  Sxmlelement      elem,
  msrPlacementKind placementKind)
{
...
//________________________________________________________________________
void msr2MeitreeTranslator::appendToNoteNotationsArticulations (
  Sxmlelement      elem,
  msrPlacementKind placementKind)
{
...
//________________________________________________________________________
void msr2MeitreeTranslator::appendToNoteNotationsTechnicals (
  Sxmlelement      elem,
  msrPlacementKind placementKind)
{
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrScore& elt)
{
#ifdef TRACE_OAH
  int inputLineNumber =
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrIdentification& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrIdentification& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrScaling& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrScaling& elt)
{
  gIndenter--;
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrPageLayout& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrPageLayout& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrSystemLayout& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrSystemLayout& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrStaffLayout& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrStaffLayout& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrMeasureLayout& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrMeasureLayout& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::populateAppearanceLineWidths (
...
void msr2MeitreeTranslator::populateAppearanceNoteSizes (
  Sxmlelement                appearanceElement,
...
void msr2MeitreeTranslator::populateAppearanceDistances (
  Sxmlelement                appearanceElement,
...
void msr2MeitreeTranslator::populateAppearanceGlyphs (
  Sxmlelement             appearanceElement,
...
void msr2MeitreeTranslator::populateAppearanceOtherAppearances (
  Sxmlelement       appearanceElement,
...
void msr2MeitreeTranslator::visitStart (S_msrAppearance& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrAppearance& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrCredit& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrCredit& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitStart (S_msrCreditWords& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrCreditWords& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrPartGroup& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2MeitreeTranslator::visitEnd (S_msrPartGroup& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
int msr2MeitreeTranslator::wholeNotesAsDivisions (
  int      inputLineNumber,
  rational wholeNotes)
{
  rational
...
void msr2MeitreeTranslator::visitStart (S_msrPart& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2MeitreeTranslator::visitEnd (S_msrPart& elt)
{
#ifdef TRACE_OAH
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrSegment& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber () ;
...
void msr2MeitreeTranslator::visitEnd (S_msrSegment& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrMeasure& elt)
{
  int
    inputLineNumber =
      elt->getInputLineNumber ();
...
void msr2MeitreeTranslator::visitEnd (S_msrMeasure& elt)
{
#ifdef TRACE_OAH
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrPrintLayout& elt)
{
#ifdef TRACE_OAH
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2MeitreeTranslator::visitEnd (S_msrPrintLayout& elt)
{
#ifdef TRACE_OAH
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrClef& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrClef& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrKey& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2MeitreeTranslator::visitEnd (S_msrKey& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrTime& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrTime& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrTempo& elt)
{
#ifdef TRACE_OAH
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2MeitreeTranslator::visitEnd (S_msrTempo& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrChord& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2MeitreeTranslator::visitEnd (S_msrChord& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrTuplet& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2MeitreeTranslator::visitEnd (S_msrTuplet& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2MeitreeTranslator:: appendNoteWedges (S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator:: appendNoteDynamics (S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator:: appendABackupToMeasure (S_msrNote note)
{
  int inputLineNumber =
...
//________________________________________________________________________
void msr2MeitreeTranslator:: appendAForwardToMeasure (S_msrNote note)
{
  int inputLineNumber =
     note->getInputLineNumber ();
...
//________________________________________________________________________
void msr2MeitreeTranslator:: appendABackupOrForwardToMeasureIfNeeded (
  S_msrNote note)
{
#ifdef TRACE_OAH
  int inputLineNumber =
...
//________________________________________________________________________
void msr2MeitreeTranslator:: populateNoteDirections (S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator:: appendNoteOrnaments (S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator:: appendNoteTechnicals (S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator:: appendNoteTechnicalWithIntegers (
  S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
...
//________________________________________________________________________
void msr2MeitreeTranslator:: appendNoteTechnicalWithFloats (
  S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
...
//________________________________________________________________________
void msr2MeitreeTranslator:: appendNoteTechnicalWithStrings (
  S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
...
//________________________________________________________________________
void msr2MeitreeTranslator:: appendNoteArticulations (S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator:: appendNoteTieIfAny (
  S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
...
//________________________________________________________________________
void msr2MeitreeTranslator:: appendNoteSlursIfAny (
  S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
...
//________________________________________________________________________
void msr2MeitreeTranslator:: appendNoteTupletIfRelevant (
  S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
...
//________________________________________________________________________
void msr2MeitreeTranslator:: appendNoteSpannersBeforeNote (
  S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
...
//________________________________________________________________________
void msr2MeitreeTranslator:: appendNoteSpannersAfterNote (
  S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
...
//________________________________________________________________________
void msr2MeitreeTranslator:: appendStemToNote (S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::appendBeamsToNote (S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator:: appendStaffToNoteIfRelevant (S_msrNote note)
{
#ifdef TRACE_OAH
  int inputLineNumber =
    note->getInputLineNumber ();
...
//________________________________________________________________________
void msr2MeitreeTranslator::appendVoiceToNoteIfRelevant (
  S_msrNote note)
{
#ifdef TRACE_OAH
  int inputLineNumber =
...
//________________________________________________________________________
void msr2MeitreeTranslator:: appendNoteNotationsToNote (S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator:: appendNoteLyricsToNote (S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::appendBasicsToNote (
  S_msrNote note)
{
  int inputLineNumber =
    note->getInputLineNumber ();
...
//________________________________________________________________________
void msr2MeitreeTranslator::appendDurationToNoteIfRelevant (
  S_msrNote note)
{
  int inputLineNumber =
    note->getInputLineNumber ();
...
void msr2MeitreeTranslator::appendTimeModificationToNoteIfRelevant (
  S_msrNote note)
{
#ifdef TRACE_OAH
  int inputLineNumber =
...
//________________________________________________________________________
void msr2MeitreeTranslator::appendNoteToMesureIfRelevant (
  S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrGraceNotesGroup& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber () ;
...
void msr2MeitreeTranslator::visitEnd (S_msrGraceNotesGroup& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber () ;
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrNote& elt)
{
#ifdef TRACE_OAH
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2MeitreeTranslator::visitEnd (S_msrNote& elt)
{
#ifdef TRACE_OAH
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrBarline& elt)
{
#ifdef TRACE_OAH
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2MeitreeTranslator::visitEnd (S_msrBarline& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
/*
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrStaffLinesNumber& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrStaffTuning& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrStaffDetails& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrStaffDetails& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrStaff& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrStaff& elt)
{
  gIndenter--;
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrVoice& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2MeitreeTranslator::visitEnd (S_msrVoice& elt)
{
  gIndenter--;
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrVoiceStaffChange& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrHarmony& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitStart (S_msrHarmonyDegree& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrHarmony& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrFrame& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrFiguredBass& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitStart (S_msrFigure& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrFiguredBass& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
/*
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrStanza& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrStanza& elt)
{
  gIndenter--;
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrSyllable& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2MeitreeTranslator::visitEnd (S_msrSyllable& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrTranspose& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrTranspose& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrPartNameDisplay& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrPartAbbreviationDisplay& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrRehearsal& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrRehearsal& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrFermata& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrArpeggiato& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrNonArpeggiato& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrTechnical& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrTechnical& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrTechnicalWithInteger& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrTechnicalWithInteger& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrTechnicalWithFloat& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrTechnicalWithFloat& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrTechnicalWithString& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrTechnicalWithString& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrOrnament& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrOrnament& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrGlissando& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrGlissando& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrSlide& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrSlide& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrSingleTremolo& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrSingleTremolo& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrDoubleTremolo& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrDoubleTremolo& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrDynamics& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrDynamics& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrOtherDynamics& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrOtherDynamics& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrWords& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2MeitreeTranslator::visitEnd (S_msrWords& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrSlur& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrSlur& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrLigature& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrLigature& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrSlash& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrWedge& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrWedge& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
/*
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrOctaveShift& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrOctaveShift& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrAccordionRegistration& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrHarpPedalsTuning& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrStem& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrStem& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrBeam& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrBeam& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrTie& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrTie& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrSegno& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitStart (S_msrDalSegno& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2MeitreeTranslator::visitStart (S_msrCoda& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrEyeGlasses& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitStart (S_msrScordatura& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitStart (S_msrPedal& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitStart (S_msrDamp& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitStart (S_msrDampAll& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrBarCheck& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrBarCheck& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrBarNumberCheck& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrBarNumberCheck& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrLineBreak& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrLineBreak& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrPageBreak& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrPageBreak& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrRepeat& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2MeitreeTranslator::visitEnd (S_msrRepeat& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrRepeatCommonPart& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2MeitreeTranslator::visitEnd (S_msrRepeatCommonPart& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrRepeatEnding& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2MeitreeTranslator::visitEnd (S_msrRepeatEnding& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrRestMeasures& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2MeitreeTranslator::visitEnd (S_msrRestMeasures& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrRestMeasuresContents& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2MeitreeTranslator::visitEnd (S_msrRestMeasuresContents& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrMeasuresRepeat& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2MeitreeTranslator::visitEnd (S_msrMeasuresRepeat& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrMeasuresRepeatPattern& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2MeitreeTranslator::visitEnd (S_msrMeasuresRepeatPattern& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrMeasuresRepeatReplicas& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2MeitreeTranslator::visitEnd (S_msrMeasuresRepeatReplicas& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2MeitreeTranslator::visitStart (S_msrMidiTempo& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2MeitreeTranslator::visitEnd (S_msrMidiTempo& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
/*
//________________________________________________________________________
void msr2MeitreeTranslator::displayCurrentOnGoingValues ()
{
  fLogOutputStream <<
    "Ongoing value:" <<
    endl;
