...
\mxmlToLy\ is mentioned too: this translator of \mxml\ to \lily\ is supplied with \lily. The design goals of \mxmlToLy\ are to perform at least as well as \mxmlToLy, while providing as many options as needed to avoid too much editing of the resulting \lcg.
...
This can be seen in \mxmlfile{articulations/ArticulationsAndOrnaments.xml}:\\
...
% -------------------------------------------------------------------------
\subsection{Tie and slur example}
% -------------------------------------------------------------------------
