...
#include "xml2bmmlOahDualHandler.h"
...
*/
//______________________________________________________________________________
S_xml2bmmlOahDualHandler xml2bmmlOahDualHandler::create (
  string   executableName,
  ostream& os)
{
  xml2bmmlOahDualHandler* o = new
...
xml2bmmlOahDualHandler::xml2bmmlOahDualHandler (
  string   executableName,
  ostream& os)
  : oahDualHandler (
      "xml2bmmlOahDualHandler",
...
void xml2bmmlOahDualHandler::createTheTwoHandlers (
  ostream& os)
{
#ifdef TRACE_OAH
#ifdef OAH_TESTS
  ...
  fUserHandler =
    xml2bmmlInsiderOahHandler::createWithOnlyThePrefixes (
      fExecutableName,
...
void xml2bmmlOahDualHandler::createUserHandlerGroups (
  ostream& os)
{
#ifdef TRACE_OAH
#ifdef OAH_TESTS
...
void xml2bmmlOahDualHandler::createOahUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createInformationsUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createWarningAndErrorsUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createPresentationUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createInputUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createFilesUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createPartsUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createStavesUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createVoicesUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createTranspositionsUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createClefsUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createKeysUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createTimesUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createRepeatsUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createMeasuresUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createRestsUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createNotesUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::creatBeamsUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createArticulationsUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createOrnamentsUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createGraceNotesUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createChordsUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createTiesUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createSlursUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createLigaturesUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createDynamicsUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createWedgesUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createTupletsUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createStringsUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createTablaturesUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createHarmoniesUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createFiguredBassesUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createLyricsUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::createOutputUserGroup (
  ostream& os)
{
  // group
...
void xml2bmmlOahDualHandler::checkOptionsAndArguments ()
{
  if (
    // xml2bmmlInsiderOahHandler?
    S_xml2bmmlInsiderOahHandler
      theXml2bmmlInsiderOahHandler =
        dynamic_cast<xml2bmmlInsiderOahHandler*>(&(*fOahHandlerToBeUsed))
  ) {
    theXml2bmmlInsiderOahHandler->
    ...
    s <<
      "xml2bmmlInsiderOahHandler expected for checkOptionsAndArguments()";
...
/*
bool xml2bmmlOahDualHandler::fetchExit2a () const
{
  bool result;
  ...
  if (
    ...
    s <<
      "xml2bmmlInsiderOahHandler expected for fetchLoopBackToMusicXML()";

    oahError (s.str ());
  }
}

bool xml2bmmlOahDualHandler::fetchExit2b () const
{
  bool result;
...
string xml2bmmlOahDualHandler::asString () const
{
  return "xml2bmmlOahDualHandler";
}

void xml2bmmlOahDualHandler::print (ostream& os) const
{
  os <<
    "xml2bmmlOahDualHandler:" <<
    endl;
...
ostream& operator<< (ostream& os, const S_xml2bmmlOahDualHandler& elt)
{
  elt->print (os);
  return os;
}
...
/*
string xml2bmmlDualHandlerInsiderAtom::asShortNamedOptionString () const
{
  stringstream s;

  s <<
    "-" << fShortName << " " <<
    S_xml2bmmlOahDualHandlerAsString (fXml2bmmlOahDualHandlerVariable);

  return s.str ();
}

string xml2bmmlDualHandlerInsiderAtom::asActualLongNamedOptionString () const
{
  stringstream s;
