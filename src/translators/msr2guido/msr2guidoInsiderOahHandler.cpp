...
//______________________________________________________________________________
void msr2guidoInsiderOahHandler::createTheMsr2guidoOptionGroups (
  string executableName)
{
#ifdef TRACING_IS_ENABLED
#ifdef ENFORCE_TRACE_OAH
...
//______________________________________________________________________________
void msr2guidoInsiderOahHandler::checkOptionsAndArgumentsFromArgcAndArgv () const
{
#ifdef TRACING_IS_ENABLED
...
//______________________________________________________________________________
string msr2guidoInsiderOahHandler::fetchOutputFileNameFromTheOptions () const
{
#ifdef TRACING_IS_ENABLED
  if (gGlobalTraceOahGroup->getTraceOah ()) {
    gLogStream <<
  ...
  if (outputFileNameHasBeenSet) {
    ...
    if (autoOutputFileNameHasBeenSet) {
      ...
      if (gGlobalTraceOahGroup->getTraceOah ()) {
        gLogStream <<
          "msr2guidoInsiderOahHandler::fetchOutputFileNameFromTheOptions(): result 1 = \"" <<
          result <<
          "\"" <<
          endl;
      }
      ...
      if (gGlobalTraceOahGroup->getTraceOah ()) {
        gLogStream <<
          "msr2guidoInsiderOahHandler::fetchOutputFileNameFromTheOptions(): result 2 = " <<
          result <<
          "\"" <<
          endl;
      }
...
//______________________________________________________________________________
void msr2guidoInsiderOahHandler::checkHandlerOptionsConsistency ()
{}

//______________________________________________________________________________
void msr2guidoInsiderOahHandler::enforceHandlerQuietness ()
{
#ifdef TRACING_IS_ENABLED
...
//______________________________________________________________________________
void msr2guidoInsiderOahHandler::print (ostream& os) const
{
...
ostream& operator<< (ostream& os, const S_msr2guidoInsiderOahHandler& elt)
{
  elt->print (os);
  return os;
}
