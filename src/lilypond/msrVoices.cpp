  ...
  string context)
{
  ...
  if (fCurrentVoiceMeasuresRepeat) {
...
// BOFBOFBOF JMI
        ...
        if (
          ...
          gLogIOstream <<
            "Creating a measures repeat replicas FAA contents for voice \"" <<
            fVoiceName << "\" is:" <<
            endl;
        }
#endif
    ...
    case msrVoice::kFiguredBassVoice:
      {
        ...
        // sanity check
        msrAssert (
          fCurrentVoiceMeasuresRepeat != nullptr,
          "fCurrentVoiceMeasuresRepeat is null");
