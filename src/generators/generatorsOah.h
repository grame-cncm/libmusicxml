...
#ifndef ___generatorsOah___
#define ___generatorsOah___

#include "msr.h"

#include "generatorsBasicTypes.h"

// JMI #include "msrGeneratorsBasicTypes.h"
...
class EXP generatorsOahGroup : public oahGroup
{
  public:
    ...
    static SMARTP<generatorsOahGroup> create ();
  ...
  private:
    ...
    void                  initializeGeneratorsOahGroup ();
...
// JMI    void                  initializeGeneratorsTraceOah ();
#endif
  ...
  public:
    ...
    void                  printGeneratorsOahHelp ();

    void                  printGeneratorsOahValues (
...
typedef SMARTP<generatorsOahGroup> S_generatorsOahGroup;
EXP ostream& operator<< (ostream& os, const S_generatorsOahGroup& elt);

EXP extern S_generatorsOahGroup gGlobalGeneratorsOahGroup;

//______________________________________________________________________________
EXP S_generatorsOahGroup createGlobalGeneratorsOahGroup ();
