...
#ifndef ___msdl2xmlRegularHandler___
#define ___msdl2xmlRegularHandler___
...
class EXP msdl2xmlRegularHandler : public oahRegularHandler
/*
  An msdl2xml regular OAH handler can rely on the existence of an insider handler,
  whose creation initialized gGlobalMsdl2xmlInsiderOahGroup.
...
*/
{
  public:
    ...
    static SMARTP<msdl2xmlRegularHandler> create (
  ...
  protected:
    ...
    virtual               ~msdl2xmlRegularHandler ();
...
typedef SMARTP<msdl2xmlRegularHandler> S_msdl2xmlRegularHandler;
EXP ostream& operator<< (ostream& os, const S_msdl2xmlRegularHandler& elt);
