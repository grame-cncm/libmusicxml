...
#ifndef ___msr2MeitreeTranslator___
#define ___msr2MeitreeTranslator___
...

{
  public:
    ...
    virtual ~msr2MeitreeTranslator ();

    void buildMeitreeFromMsrScore ();
...
*/
    ...
    void                      createMeiAttributesElementAndAppendItToMeasure ();
