...
xml2PartsInfoExtractor::xml2PartsInfoExtractor (
  S_xmlPartsInfoOptions& msrOpts)
{
  ...
  fMsrScore =
    msrScore::create (fxmlPartsInfoOptions, 0);
...
//________________________________________________________________________
S_xmlPartsInfo xml2PartsInfoExtractor::extractPartsInfoFromXMLElementTree (
  const Sxmlelement& xmlTree)
{
  S_xmlPartsInfo result;
...
//______________________________________________________________________________
S_msrVoice xml2PartsInfoExtractor::registerVoiceInStaffInCurrentPartIfNeeded (
  int            inputLineNumber,
  int            staffNumber,
  int            voiceNumber)
{
...
//______________________________________________________________________________
void xml2PartsInfoExtractor::visitStart ( S_millimeters& elt )
{ 
...
void xml2PartsInfoExtractor::visitStart ( S_tenths& elt )
{
  fTenths = (int)(*elt);
...
void xml2PartsInfoExtractor::visitEnd ( S_scaling& elt)
{
...
//________________________________________________________________________
void xml2PartsInfoExtractor::visitStart (S_part_list& elt)
{
  if (gGeneralOptions->fTrace)
    cerr << idtr <<
      "Analysing part list" <<
...
void xml2PartsInfoExtractor::visitEnd (S_part_list& elt)
{
  idtr--;
...
//________________________________________________________________________
void xml2PartsInfoExtractor::visitStart (S_score_part& elt)
{
...
void xml2PartsInfoExtractor::visitStart (S_part_name& elt)
{
  fCurrentPartName = elt->getValue ();
}

void xml2PartsInfoExtractor::visitStart (S_part_abbreviation& elt)
{
  fCurrentPartAbbreviation = elt->getValue ();
}

void xml2PartsInfoExtractor::visitStart (S_instrument_name& elt)
{
  fCurrentPartInstrumentName = elt->getValue();
}

void xml2PartsInfoExtractor::visitEnd (S_score_part& elt)
{
...
//________________________________________________________________________
void xml2PartsInfoExtractor::visitStart (S_part& elt)
{
...
void xml2PartsInfoExtractor::visitEnd (S_part& elt)
{
  if (gGeneralOptions->fTrace)
    cerr <<
      idtr <<
...
//______________________________________________________________________________
void xml2PartsInfoExtractor::visitStart ( S_divisions& elt ) 
{
...
//______________________________________________________________________________
void xml2PartsInfoExtractor::visitStart (S_words& elt)
{
/*
...
//________________________________________________________________________
void xml2PartsInfoExtractor::visitStart (S_staves& elt)
{
...
//________________________________________________________________________
void xml2PartsInfoExtractor::visitStart (S_staff& elt)
{
  /*
        <note>
        <pitch>
...
//________________________________________________________________________
void xml2PartsInfoExtractor::visitStart (S_voice& elt )
{
  /*
        <note>
        <pitch>
...
//________________________________________________________________________
void xml2PartsInfoExtractor::visitStart (S_lyric& elt )
{ 
...
void xml2PartsInfoExtractor::visitStart ( S_syllabic& elt )
{
...
void xml2PartsInfoExtractor::visitEnd ( S_text& elt ) 
{
...
void xml2PartsInfoExtractor::visitEnd ( S_elision& elt ) 
{
  fCurrentElision = true;
}

void xml2PartsInfoExtractor::visitEnd ( S_lyric& elt )
{
   int inputLineNumber =
      elt->getInputLineNumber ();
...
//________________________________________________________________________
void xml2PartsInfoExtractor::visitStart (S_measure& elt)
{
/*
...
void xml2PartsInfoExtractor::visitEnd (S_measure& elt)
{
...
//______________________________________________________________________________
void xml2PartsInfoExtractor::visitStart ( S_note& elt ) 
{
  //  cerr << "--> xml2PartsInfoExtractor::visitStart ( S_note& elt ) " << endl;
...
//______________________________________________________________________________
void xml2PartsInfoExtractor::visitStart ( S_rest& elt)
{
  /*
        <note>
        <rest/>
...
*/
  //  cerr << "--> xml2PartsInfoExtractor::visitStart ( S_rest& elt ) " << endl;
  fNoteData.fStepIsARest = true;
}

//______________________________________________________________________________
void xml2PartsInfoExtractor::visitEnd ( S_note& elt )
{
  /*
...
//______________________________________________________________________________
void xml2PartsInfoExtractor::handleLyrics (S_msrNote newNote)
{
...
//______________________________________________________________________________
void xml2PartsInfoExtractor::visitStart ( S_harmony& elt )
{
}

void xml2PartsInfoExtractor::visitEnd ( S_harmony& elt )
{
  // create the harmony
  S_msrHarmony
    harmony =
