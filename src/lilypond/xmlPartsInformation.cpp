...
S_xmlPartsInformationOptions xmlPartsInformationOptions::create ()
{
  xmlPartsInformationOptions* o = new xmlPartsInformationOptions();
  assert(o!=0);
  return o;
}

xmlPartsInformationOptions::xmlPartsInformationOptions () {}

xmlPartsInformationOptions::~xmlPartsInformationOptions () {}

//______________________________________________________________________________
xmlPartsInformationElement::xmlPartsInformationElement (
  S_xmlPartsInformationOptions& msrOpts, 
  int           inputLineNumber)
{
  fxmlPartsInformationOptions      = msrOpts;
  fInputLineNumber = inputLineNumber;  
}

xmlPartsInformationElement::~xmlPartsInformationElement() {}

ostream& operator<< (ostream& os, const S_xmlPartsInformationElement& elt)
{
  elt->print (os);
  return os;
}

void xmlPartsInformationElement::print (ostream& os)
{
  os << "??? Element ???" << endl;
}
...
msrPageGeometry::msrPageGeometry (
  S_xmlPartsInformationOptions& msrOpts, 
  int           inputLineNumber)
    : xmlPartsInformationElement (msrOpts, inputLineNumber)
{
  fPaperWidth   = -1.0;
  fPaperHeight  = -1.0;
  fTopMargin    = -1.0;
...
S_xmlPartsInformationElement msrMeasure::removeLastElementFromMeasure (
  int inputLineNumber)
{
  S_xmlPartsInformationElement result;
...
void msrMeasure::browseData (basevisitor* v)
{
  ...
  for (
    list<S_xmlPartsInformationElement>::iterator i = fMeasureElementsList.begin();
    i != fMeasureElementsList.end();
    i++) {
    // browse the element
    msrBrowser<xmlPartsInformationElement> browser (v);
    browser.browse (*(*i));
  } // for
...
*/
  ...
  if (! fMeasureElementsList.size ())
    ...
    list<S_xmlPartsInformationElement>::const_iterator
    ...
    : xmlPartsInformationElement (msrOpts, inputLineNumber)
{
  ...
  if (clef) {
    // append it to the voice chunk
    S_xmlPartsInformationElement c = clef;
    fVoiceVoicechunk->
  ...
  if (! key)
    ...
    if (key) {
      // append it to the voice chunk
      S_xmlPartsInformationElement k = key;
      fVoiceVoicechunk->
  ...
  */
    if (time) {
      // append it to the voice chunk
      S_xmlPartsInformationElement t = time;
      fVoiceVoicechunk->
  ...
  // get the initial transpose from the staff if any
  {
    ...
    if (transpose) {
      // append it to the voice chunk
      S_xmlPartsInformationElement t = transpose;
      fVoiceVoicechunk->
        appendElementToVoicechunk (t);
    }
  }
...
void msrVoice::appendWordsToVoice (S_msrWords words)
{
  ...
  S_xmlPartsInformationElement w = words;
  fVoiceVoicechunk->
...
void msrVoice::appendTempoToVoice (S_msrTempo tempo)
{
  ...
  S_xmlPartsInformationElement t = tempo;
  fVoiceVoicechunk->
    appendElementToVoicechunk (t);
}
...
void msrVoice::appendOctaveShiftToVoice (S_msrOctaveShift octaveShift)
{
  ...
  S_xmlPartsInformationElement o = octaveShift;
  fVoiceVoicechunk->
...
void msrVoice::appendRehearsalToVoice (S_msrRehearsal rehearsal)
{
  ...
  S_xmlPartsInformationElement r = rehearsal;
  fVoiceVoicechunk->
...
void msrVoice::appendChordToVoice (S_msrChord chord)
{
  ...
  S_xmlPartsInformationElement c = chord;
  fVoiceVoicechunk->
    appendElementToVoicechunk (c);
...
void msrVoice::appendTupletToVoice (S_msrTuplet tuplet) {
  ...
  S_xmlPartsInformationElement t = tuplet;
  fVoiceVoicechunk->
    appendElementToVoicechunk (t);
...
//  if (gGeneralOptions->fForceDebug || gGeneralOptions->fDebugDebug)
  ...
  S_xmlPartsInformationElement g = gracenotes;
  fVoiceVoicechunk->
...
void msrVoice::appendRepeatToVoice (S_msrRepeat repeat) {
  ...
  S_xmlPartsInformationElement r = repeat;
  fVoiceVoicechunk->
    appendElementToVoicechunk (r);
}
...
void msrVoice::prependBarlineToVoice (S_msrBarline barline) {
  ...
  S_xmlPartsInformationElement b = barline;
  fVoiceVoicechunk->
...
void msrVoice::appendSegnoToVoice (S_msrSegno segno) {
  ...
  S_xmlPartsInformationElement s = segno;
  fVoiceVoicechunk->
...
void msrVoice::appendCodaToVoice (S_msrCoda coda) {
  ...
  S_xmlPartsInformationElement c = coda;
  fVoiceVoicechunk->
    appendElementToVoicechunk (c);
}
...
void msrVoice::appendEyeglassesToVoice (S_msrEyeglasses eyeglasses) {
  ...
  S_xmlPartsInformationElement e = eyeglasses;
  fVoiceVoicechunk->
...
void msrVoice::appendPedalToVoice (S_msrPedal pedal) {
  ...
  S_xmlPartsInformationElement e = pedal;
  fVoiceVoicechunk->
    appendElementToVoicechunk (e);
}

/* JMI
void msrVoice::appendElementToVoice (S_xmlPartsInformationElement elem)
{
  if (gGeneralOptions->fDebugDebug)
    cerr << idtr <<
...
S_xmlPartsInformationElement msrVoice::removeLastElementFromVoice (
  int inputLineNumber)
{
  if (gGeneralOptions->fDebugDebug)
    cerr << idtr <<
...
//______________________________________________________________________________
S_xmlPartsInformation xmlPartsInformation::create (
  S_xmlPartsInformationOptions& msrOpts, 
  int           inputLineNumber)
{
  xmlPartsInformation* o =
    new xmlPartsInformation (
      msrOpts, inputLineNumber);
  assert(o!=0);
  return o;
}

xmlPartsInformation::xmlPartsInformation (
  S_xmlPartsInformationOptions& msrOpts, 
  int           inputLineNumber)
    : xmlPartsInformationElement (msrOpts, inputLineNumber)
{
...
void xmlPartsInformation::addPartgroupToScore (S_msrPartgroup partgroup)
{
  // register it in this score
  fPartgroupsList.push_back (partgroup);
}

ostream& operator<< (ostream& os, const S_xmlPartsInformation& elt)
{
  elt->print (os);
  return os;
}

void xmlPartsInformation::print (ostream& os)
{
  os <<
    "MSR Score" <<
