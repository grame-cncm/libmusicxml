...
% Generated by xml2ly 0.93 from "lyrics/Extend.xml"
% on Wednesday 2020-04-22 @ 11:27:03 CEST

% The translation command line was:
%   xml2ly '-xi' '-aofn' '-dmsr' '-dpg' '--dlpsr' '-abn' '-lpcd' '-rbracks' '-mssp' '1cm' '-loop' 'lyrics/Extend.xml'
% or, with long option names:
%  xml2ly lyrics/Extend.xml -xml2ly-infos -auto-output-file-name -display-msr -display-partgroups -display-lpsr -all-bar-numbers -lilypond-compile-date -repeat-brackets -markup-system-spacing.padding '1 cm' -loop-to-musicxml
% or, with short option names:
%   xml2ly lyrics/Extend.xml -xi -aofn -dmsr -dpg -dlpsr -abn -lpcd -rbracks -mssp '1 cm' -loop
...
Part_POne_Staff_One_Voice_One = \absolute {
  ...
  \clef "treble"
  \once\override Score.MetronomeMark.direction = #DOWN\tempo \markup {
    "Allegro"\concat {
