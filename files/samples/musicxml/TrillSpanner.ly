...
% Generated by xml2ly 0.93 from "ornaments/TrillSpanner.xml"
% on Monday 2020-03-09 @ 17:56:23 CET

% The translation command line was:
%   xml2ly '-xi' '-aofn' '-dmsr' '-dpg' '--dlpsr' '-abn' '-lpcd' '-rbracks' '-mssp' '1cm' '-loop' 'ornaments/TrillSpanner.xml'
% or, with long option names:
%  xml2ly ornaments/TrillSpanner.xml -xml2ly-infos -auto-output-file-name -display-msr -display-partgroups -display-lpsr -all-bar-numbers -lilypond-compile-date -repeat-brackets -markup-system-spacing.padding '1 cm' -loop-to-musicxml
% or, with short option names:
%   xml2ly ornaments/TrillSpanner.xml -xi -aofn -dmsr -dpg -dlpsr -abn -lpcd -rbracks -mssp '1 cm' -loop
...
Part_POne_Staff_One_Voice_One = \absolute {
  ...
  \clef "treble"
  c'1 \startTrillSpan | % 2
  \barNumberCheck #2
  g'1 \stopTrillSpan \stopTrillSpan | % 3
  \barNumberCheck #3
}
