...
//______________________________________________________________________________
void msr2lilypondInsiderOahHandler::createTheMsr2lilypondPrefixes ()
{
#ifdef TRACING_IS_ENABLED
#ifdef ENFORCE_TRACE_OAH
  gLogStream <<
...
//______________________________________________________________________________
void msr2lilypondInsiderOahHandler::createTheMsr2lilypondOptionGroups (
  string executableName)
{
#ifdef TRACING_IS_ENABLED
#ifdef ENFORCE_TRACE_OAH
  ...
  if (gGlobalTraceOahGroup->getTraceOahDetails ()) {
    ...
    gLogStream <<
      "msr2lilypondInsiderOahHandler has been initialized as:" <<
      endl;
...
if (gGlobalTraceOahGroup->getTraceOahDetails ()) {
    gLogStream <<
      "msr2lilypondInsiderOahHandler help:" <<
      endl;
...
//______________________________________________________________________________
void msr2lilypondInsiderOahHandler::checkOptionsAndArgumentsFromArgcAndArgv () const
{
#ifdef TRACING_IS_ENABLED
...
//______________________________________________________________________________
string msr2lilypondInsiderOahHandler::fetchOutputFileNameFromTheOptions () const
{
#ifdef TRACING_IS_ENABLED
  if (gGlobalTraceOahGroup->getTraceOah ()) {
    gLogStream <<
  ...
  if (outputFileNameHasBeenSet) {
    ...
    if (autoOutputFileNameHasBeenSet) {
      ...
      if (gGlobalTraceOahGroup->getTraceOah ()) {
        gLogStream <<
          "msr2lilypondInsiderOahHandler::fetchOutputFileNameFromTheOptions(): result 1 = \"" <<
          result <<
          "\"" <<
          endl;
      }
      ...
      if (gGlobalTraceOahGroup->getTraceOah ()) {
        gLogStream <<
          "msr2lilypondInsiderOahHandler::fetchOutputFileNameFromTheOptions(): result 2 = " <<
          result <<
          "\"" <<
          endl;
      }
...
//______________________________________________________________________________
void msr2lilypondInsiderOahHandler::checkHandlerOptionsConsistency ()
{}

//______________________________________________________________________________
void msr2lilypondInsiderOahHandler::enforceHandlerQuietness ()
{
#ifdef TRACING_IS_ENABLED
...
//______________________________________________________________________________
void msr2lilypondInsiderOahHandler::print (ostream& os) const
{
  const unsigned int fieldWidth = 27;

  os <<
    "msr2lilypondInsiderOahHandler '" << fHandlerHeader << "':" <<
    endl;
...
ostream& operator<< (ostream& os, const S_msr2lilypondInsiderOahHandler& elt)
{
  elt->print (os);
  return os;
}
