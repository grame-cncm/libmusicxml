...
void msr2lilypondRegularHandler::createInputRegularGroup ()
{
  // group
...
void msr2lilypondRegularHandler::createDynamicsRegularGroup ()
{
  // group
...
void msr2lilypondRegularHandler::createFiguredBassesRegularGroup ()
{
  // group
