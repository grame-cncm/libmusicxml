...
void xml2lyRegularHandler::createDynamicsRegularGroup ()
{
  // group
...
void xml2lyRegularHandler::createFiguredBassesRegularGroup ()
{
  // group
...
//______________________________________________________________________________
void xml2lyRegularHandler::checkOptionsAndArgumentsFromArgcAndArgv () const
{
#ifdef TRACING_IS_ENABLED
  if (getTraceOah ()) {
    gLogStream <<
...
void xml2lyRegularHandler::print (ostream& os) const
{
  ...
  os <<
    "xml2lyRegularHandler '" << fHandlerHeader << "':" <<
    endl;
