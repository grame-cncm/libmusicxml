  ...
  int inputLineNumber) const
{
  ...
  if (
    gGlobalTraceOahGroup->fTraceMeasures
      ||
    gGlobalTraceOahGroup->fTraceSegments
      ||
    gGlobalTraceOahGroup->fTraceRepeats
  ) {
    fSegmentVoiceUpLink->
...
{
#ifdef TRACE_OAH
  if (gGlobalTraceOahGroup->fTraceSegnos) {
    gLogOstream <<
      "Appending segno " <<
      " to segment " << asString () <<
      "' in voice \"" <<
...
{
#ifdef TRACE_OAH
  if (gGlobalTraceOahGroup->fTraceCodas) {
    gLogOstream <<
      "Appending coda " <<
      " to segment " << asString () <<
      "' in voice \"" <<
...
{
#ifdef TRACE_OAH
  if (gGlobalTraceOahGroup->fTraceEyeGlasses) {
    gLogOstream <<
...
{
#ifdef TRACE_OAH
  if (gGlobalTraceOahGroup->fTracePedals) {
    gLogOstream <<
      "Appending pedal " <<
      " to segment " << asString () <<
      "' in voice \"" <<
...
{
#ifdef TRACE_OAH
  if (gGlobalTraceOahGroup->fTraceDamps) {
    gLogOstream <<
      "Appending damp " <<
      " to segment " << asString () <<
      "' in voice \"" <<
...
{
#ifdef TRACE_OAH
  if (gGlobalTraceOahGroup->fTraceDampAlls) {
    gLogOstream <<
      "Appending damp all " <<
      " to segment " << asString () <<
      "' in voice \"" <<
  ...
  S_msrStaffDetails staffDetails)
{
  ...
  if (
    gGlobalTraceOahGroup->fTraceStaffDetails
      ||
    gGlobalTraceOahGroup->fTraceSegments
  ) {
    gLogOstream <<
...
{
#ifdef TRACE_OAH
  if (gGlobalTraceOahGroup->fTraceLineBreaks) {
    gLogOstream <<
      "Appending break '" <<
...
{
#ifdef TRACE_OAH
  if (gGlobalTraceOahGroup->fTracePageBreaks) {
    gLogOstream <<
      "Appending break " <<
      " to segment " << asString () <<
      "' in voice \"" <<
...
{
#ifdef TRACE_OAH
  if (gGlobalTraceOahGroup->fTraceBarNumberChecks) {
    gLogOstream <<
...
{
#ifdef TRACE_OAH
  if (gGlobalTraceOahGroup->fTraceRehearsals) {
    gLogOstream <<
      "Appending rehearsal " <<
      " to segment " << asString () <<
      "' in voice \"" <<
...
{
#ifdef TRACE_OAH
  if (gGlobalTraceOahGroup->fTraceOctaveShifts) {
    gLogOstream <<
...
{
#ifdef TRACE_OAH
  if (gGlobalTraceOahGroup->fTraceScordaturas) {
    gLogOstream <<
...
{
#ifdef TRACE_OAH
  if (gGlobalTraceOahGroup->fTraceBarChecks) {
    gLogOstream <<
