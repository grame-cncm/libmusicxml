...
S_xml2brlManPageOah gxml2brlManPageOah;
S_xml2brlManPageOah gxml2brlManPageOahUserChoices;
S_xml2brlManPageOah gxml2brlManPageOahWithDetailedTrace;
...
//______________________________________________________________________________
void xml2brlManPageOah::enforceQuietness ()
{
// JMI  fDisplayOah = false;
}

//______________________________________________________________________________
void xml2brlManPageOah::checkOptionsConsistency ()
{
  // JMI
}
  ...
  S_oahVisitor theOah2ManPageGenerator)
{
  ...
  gxml2brlManPageOahUserChoices = xml2brlManPageOah::create (
    handler,
    theOah2ManPageGenerator);
  assert(gxml2brlManPageOahUserChoices != 0);

  gxml2brlManPageOah =
    gxml2brlManPageOahUserChoices;

  // prepare for measure detailed trace
  // ------------------------------------------------------
/* JMI
  gxml2brlManPageOahWithDetailedTrace =
    gxml2brlManPageOah->
