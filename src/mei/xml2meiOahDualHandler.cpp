...
*/
//______________________________________________________________________________
S_xml2meiOahDualHandler xml2meiOahDualHandler::create (
  string   executableName,
  ostream& os)
{
  xml2meiOahDualHandler* o = new
...
xml2meiOahDualHandler::xml2meiOahDualHandler (
  string   executableName,
  ostream& os)
  : oahDualHandler (
      "xml2meiOahDualHandler",
...
void xml2meiOahDualHandler::createTheTwoHandlers (
  ostream& os)
{
#ifdef TRACE_OAH
#ifdef OAH_TESTS
  ...
  fUserHandler =
    xml2meiInsiderOahHandler::createWithOnlyThePrefixes (
      fExecutableName,
...
void xml2meiOahDualHandler::createUserHandlerGroups (
  ostream& os)
{
#ifdef TRACE_OAH
#ifdef OAH_TESTS
...
void xml2meiOahDualHandler::createOahUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createInformationsUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createWarningAndErrorsUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createPresentationUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createInputUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createFilesUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createPartsUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createStavesUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createVoicesUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createTranspositionsUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createClefsUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createKeysUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createTimesUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createRepeatsUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createMeasuresUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createRestsUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createNotesUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::creatBeamsUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createArticulationsUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createOrnamentsUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createGraceNotesUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createChordsUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createTiesUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createSlursUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createLigaturesUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createDynamicsUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createWedgesUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createTupletsUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createStringsUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createTablaturesUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createHarmoniesUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createFiguredBassesUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createLyricsUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::createOutputUserGroup (
  ostream& os)
{
  // group
...
void xml2meiOahDualHandler::checkOptionsAndArguments ()
{
  if (
    // xml2meiInsiderOahHandler?
    S_xml2meiInsiderOahHandler
      theXml2meiInsiderOahHandler =
        dynamic_cast<xml2meiInsiderOahHandler*>(&(*fOahHandlerToBeUsed))
  ) {
    theXml2meiInsiderOahHandler->
    ...
    s <<
      "xml2meiInsiderOahHandler expected for checkOptionsAndArguments()";
...
/*
bool xml2meiOahDualHandler::fetchExit2a () const
{
  bool result;
  ...
  if (
    ...
    s <<
      "xml2meiInsiderOahHandler expected for fetchLoopBackToMusicXML()";

    oahError (s.str ());
  }
}

bool xml2meiOahDualHandler::fetchExit2b () const
{
  bool result;
...
string xml2meiOahDualHandler::asString () const
{
  return "xml2meiOahDualHandler";
}

void xml2meiOahDualHandler::print (ostream& os) const
{
  os <<
    "xml2meiOahDualHandler:" <<
    endl;
...
ostream& operator<< (ostream& os, const S_xml2meiOahDualHandler& elt)
{
  elt->print (os);
  return os;
}
...
/*
string xml2meiDualHandlerInsiderAtom::asShortNamedOptionString () const
{
  stringstream s;

  s <<
    "-" << fShortName << " " <<
    S_xml2meiOahDualHandlerAsString (fXml2meiOahDualHandlerVariable);

  return s.str ();
}

string xml2meiDualHandlerInsiderAtom::asActualLongNamedOptionString () const
{
  stringstream s;
