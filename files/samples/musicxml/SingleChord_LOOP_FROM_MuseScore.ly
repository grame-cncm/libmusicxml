...
% Generated by xml2ly 0.93 from "SingleChord_LOOP_FROM_MuseScore.xml"
% on Sunday 2020-03-01 @ 09:37:24 CET

% The translation command line was:
%   xml2ly '-xi' '-aofn' '-dmsr' '-dpg' '--dlpsr' '-abn' '-lpcd' '-rbracks' '-mssp' '1cm' 'SingleChord_LOOP_FROM_MuseScore.xml' '-loop'
% or, with long option names:
%  xml2ly SingleChord_LOOP_FROM_MuseScore.xml -xml2ly-infos -auto-output-file-name -display-msr -display-partgroups -display-lpsr -all-bar-numbers -lilypond-compile-date -repeat-brackets -markup-system-spacing.padding '1 cm' -loop-to-musicxml
% or, with short option names:
%   xml2ly SingleChord_LOOP_FROM_MuseScore.xml -xi -aofn -dmsr -dpg -dlpsr -abn -lpcd -rbracks -mssp '1 cm' -loop
...
\header {
  title              = "Chords"
  software           = "MuseScore 3.4.2"
  encodingDate       = "2020-03-01"
}
