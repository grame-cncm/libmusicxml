...
#ifndef ___msr2BmmltreeTranslator___
#define ___msr2BmmltreeTranslator___
...

{
  public:
    ...
    virtual ~msr2BmmltreeTranslator ();

    void buildBmmltreeFromMsrScore ();
