...
//______________________________________________________________________________
void xml2xmlInsiderOahHandler::checkOptionsAndArgumentsFromArgcAndArgv (
...
#ifdef TRACING_IS_ENABLED
  if (gGlobalTraceOahGroup->getTraceOahDetails () && ! gGlobalGeneralOahGroup->getQuiet ()) {
...
/* JM  // JMI only if pass 5 msr2lpsr is run
