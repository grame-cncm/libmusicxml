...
string msdl2brlInsiderHandler::fetchOutputFileNameFromTheOptions () const
{
  ...
  if (outputFileNameHasBeenSet) {
    ...
    if (autoOutputFileNameHasBeenSet) {
      ...
      if (getTraceOah ()) {
        gLogStream <<
          "msdl2brlInsiderHandler::fetchOutputFileNameFromTheOptions(): outputFileName 1 = \"" <<
          outputFileName <<
          "\"" <<
          endl;
      }
      ...
      if (getTraceOah ()) {
        gLogStream <<
          "msdl2brlInsiderHandler::fetchOutputFileNameFromTheOptions(): outputFileName 2 = " <<
          outputFileName <<
          "\"" <<
          endl;
      }
      ...
      if (getTraceOah ()) {
        gLogStream <<
          "msdl2brlInsiderHandler::fetchOutputFileNameFromTheOptions(): outputFileName 3 = " <<
          outputFileName <<
          "\"" <<
          endl;
      }
