...
Here is a score containing random 3-note chords created by '{\tt RandomChords}', a C++ small program provided as a example of using \lib\ to create \mxml\ data, with source code in \cppsamplefile{RandomChords.cpp}:\\
...
The contents of \mxmlfile{challenging/BeethovenNinthSymphony.xml} is over 66 megabytes large. It was created by exporting it from \sib, and contains the whose score for this symphony.
