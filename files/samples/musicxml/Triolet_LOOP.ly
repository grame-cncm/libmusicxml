...
% Generated by xml2ly 0.93 from "Triolet_LOOP.xml"
% on Monday 2020-03-30 @ 10:28:13 CEST

% The translation command line was:
%   xml2ly '-xi' '-aofn' '-dmsr' '-dpg' '--dlpsr' '-abn' '-lpcd' '-rbracks' '-mssp' '1cm' 'Triolet_LOOP.xml'
% or, with long option names:
%  xml2ly Triolet_LOOP.xml -xml2ly-infos -auto-output-file-name -display-msr -display-partgroups -display-lpsr -all-bar-numbers -lilypond-compile-date -repeat-brackets -markup-system-spacing.padding '1 cm'
% or, with short option names:
%   xml2ly Triolet_LOOP.xml -xi -aofn -dmsr -dpg -dlpsr -abn -lpcd -rbracks -mssp '1 cm'
...
\header {
  ...
  \markup {
    \column {
      "xml2ly 0.93, https://github.com/dfober/libmusicxml/tree/lilypond"
      "Frescobaldi 2.18.1"
    }
  }
  
  encodingDate       = "2020-03-30"
}
