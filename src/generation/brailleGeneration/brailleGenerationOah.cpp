...
void brailleGenerationOahGroup::initializeBrailleEncodingOptions ()
{
  S_oahSubGroup
    subGroup =
      oahSubGroup::create (
...
void brailleGenerationOahGroup::initializeBrailleByteOrderingOptions ()
{
  S_oahSubGroup
    subGroup =
      oahSubGroup::create (
...
void brailleGenerationOahGroup::initializeBrailleMusicFileNameOptions ()
{
  S_oahSubGroup
    subGroup =
      oahSubGroup::create (
...
void brailleGenerationOahGroup::initializeBraillePageParametersOptions ()
{
  S_oahSubGroup
    subGroup =
      oahSubGroup::create (
...
void brailleGenerationOahGroup::initializeBrailleCodeGenerationOptions ()
{
  S_oahSubGroup
    subGroup =
      oahSubGroup::create (
...
//______________________________________________________________________________
void brailleGenerationOahGroup::printBrailleGenerationOahValues (unsigned int fieldWidth)
{
  gLogStream <<
