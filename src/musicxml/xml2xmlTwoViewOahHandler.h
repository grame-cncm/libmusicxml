...
#ifndef ___xml2xmlOahTwoViewHandlers___
#define ___xml2xmlOahTwoViewHandlers___
...
// data types
enum oahTwoViewHandlerViewKind {
  kViewFullView,
  kViewAlternate };

static string oahTwoViewHandlerViewKindAsString (
  oahTwoViewHandlerViewKind twoViewHandlerViewKind);
*/
//_______________________________________________________________________________
class EXP xml2xmlOahTwoViewHandler : public oahTwoViewHandler
{
  public:

    // creation
    // ------------------------------------------------------
    static SMARTP<xml2xmlOahTwoViewHandler> create (
  ...
  protected:
    ...
    virtual ~xml2xmlOahTwoViewHandler ();
...
typedef SMARTP<xml2xmlOahTwoViewHandler> S_xml2xmlOahTwoViewHandler;
EXP ostream& operator<< (ostream& os, const S_xml2xmlOahTwoViewHandler& elt);
