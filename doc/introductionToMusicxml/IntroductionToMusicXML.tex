...
The first voice in upper staff '{\tt 1}' has number '{\tt 1}'. The '{\tt <forward>}' element is used because there no note in this voice upon the first beat. This element allows drawing to continue a bit further in the voice, without drawing rests in-between:
\begin{lstlisting}[language=XML]
      <forward>
