...
S_lpsr2LilypondOah gGlobalLpsr2LilypondOah;
S_lpsr2LilypondOah gGlobalLpsr2LilypondOahUserChoices;
S_lpsr2LilypondOah gGlobalLpsr2LilypondOahWithDetailedTrace;
  ...
  S_oahHandler handler)
{
  ...
  if (! pThisMethodHasBeenRun) {
    ...
    gGlobalLpsr2LilypondOahUserChoices = lpsr2LilypondOah::create (
      handler);
    assert(gGlobalLpsr2LilypondOahUserChoices != 0);

    gGlobalLpsr2LilypondOah =
      gGlobalLpsr2LilypondOahUserChoices;

    // prepare for measure detailed trace
    // ------------------------------------------------------

  /* JMI
    gGlobalLpsr2LilypondOahWithDetailedTrace =
      gGlobalLpsr2LilypondOah->
