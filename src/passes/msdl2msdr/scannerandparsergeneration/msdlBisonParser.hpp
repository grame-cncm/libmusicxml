...
#line 217 "msdlBisonParser.hpp"
...
#else
    typedef MSDLSTYPE semantic_type;
#endif
    /// Symbol locations.
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_SPACES = 3,                            // "spaces"
        S_END_OF_LINE = 4,                       // "end of line"
        S_PARENTHESIZED_COMMENT = 5,             // "parenthesized comment"
        S_COMMENT_TO_END_OF_LINE = 6,            // "comment to end of line"
        S_EQUAL_SIGN = 7,                        // "="
        S_COMMA = 8,                             // ","
        S_COLON = 9,                             // ";"
        S_SEMI_COLON = 10,                       // ":"
        ...
        S_DOUBLE = 19,                           // "double"
        S_SINGLE_QUOTED_STRING = 20,             // "single quoted string"
        S_DOUBLE_QUOTED_STRING = 21,             // "double quoted string"
        S_IDENTIFIER = 22,                       // "identifier"
        S_OTHER_CHARACTER = 23,                  // "other character"
        S_YYACCEPT = 24,                         // $accept
        S_description = 25,                      // description
        S_declarations = 26,                     // declarations
