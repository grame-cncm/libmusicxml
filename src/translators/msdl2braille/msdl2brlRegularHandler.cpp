...
S_msdl2brlRegularHandler msdl2brlRegularHandler::create (
              ...
              insiderOahHandler)
{
  ...
  msdl2brlRegularHandler* o = new
    msdl2brlRegularHandler (
      executableName,
      handlerHeader,
      insiderOahHandler);
  assert (o!=0);
...
msdl2brlRegularHandler::msdl2brlRegularHandler (
  string      executableName,
  string      handlerHeader,
  S_msdl2brlInsiderHandler
              insiderOahHandler)
...
void msdl2brlRegularHandler::createRegularHandlerGroups ()
{
#ifdef TRACING_IS_ENABLED
  if (getTraceOah ()) {
    gLogStream <<
...
void msdl2brlRegularHandler::createOahRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createInformationsRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createWarningAndErrorsRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createPresentationRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createInputRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createFilesRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createPartsRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createStavesRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createVoicesRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createTranspositionsRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createClefsRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createKeysRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createTimesRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createRestsRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createNotesRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::creatBeamsRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createArticulationsRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createOrnamentsRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createGraceNotesRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createChordsRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createTiesRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createSlursRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createLigaturesRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createDynamicsRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createWedgesRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createTupletsRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createStringsRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createTablaturesRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createHarmoniesRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createFiguredBassesRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createLyricsRegularGroup ()
{
  // group
...
void msdl2brlRegularHandler::createOutputRegularGroup ()
{
  // group
  ...
  registerAtomInRegularSubgroup ("msdl2brl-infos", subGroup);
}

//______________________________________________________________________________
void msdl2brlRegularHandler::checkOptionsAndArgumentsFromArgcAndArgv () const
{
#ifdef TRACING_IS_ENABLED
  if (getTraceOah ()) {
    gLogStream <<
...
//______________________________________________________________________________
void msdl2brlRegularHandler::print (ostream& os) const
{
  const unsigned int fieldWidth = 27;

  os <<
    "msdl2brlRegularHandler '" << fHandlerHeader << "':" <<
    endl;
...
ostream& operator<< (ostream& os, const S_msdl2brlRegularHandler& elt)
{
  elt->print (os);
  return os;
}
