...
string xml2brlInsiderHandler::handlerExecutableAboutInformation () const
{
  return
R"(What xml2brl does:
...
string xml2brlInsiderHandler::fetchOutputFileNameFromTheOptions () const
{
  ...
  if (outputFileNameHasBeenSet) {
    ...
    if (autoOutputFileNameHasBeenSet) {
      ...
      if (gGlobalTraceOahGroup->getTraceOah ()) {
        gLogStream <<
          "xml2brlInsiderHandler::fetchOutputFileNameFromTheOptions(): result 1 = \"" <<
          result <<
          "\"" <<
          endl;
      }
      ...
      if (gGlobalTraceOahGroup->getTraceOah ()) {
        gLogStream <<
          "xml2brlInsiderHandler::fetchOutputFileNameFromTheOptions(): result 2 = " <<
          result <<
          "\"" <<
          endl;
      }
      ...
      if (gGlobalTraceOahGroup->getTraceOah ()) {
        gLogStream <<
          "xml2brlInsiderHandler::fetchOutputFileNameFromTheOptions(): result 3 = " <<
          result <<
          "\"" <<
          endl;
      }
