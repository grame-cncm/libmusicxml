...
void msrDalSegnoAtom::handleValuedAtomValue (
  string   theString,
  ostream& os)
{
#ifdef TRACE_OAH
...
void msrDalSegnoAtom::printValuedAtomOptionsValues (
  ostream& os,
...
void msrReplaceClefAtom::handleValuedAtomValue (
  string   theString,
  ostream& os)
{
#ifdef TRACE_OAH
...
void msrReplaceClefAtom::printValuedAtomOptionsValues (
  ostream& os,
  int      valueFieldWidth) const
{
  os << left <<
...
S_mxmlTree2MsrOah gGlobalMxmlTree2MsrOah;
S_mxmlTree2MsrOah gGlobalMxmlTree2MsrOahUserChoices;
S_mxmlTree2MsrOah gGlobalMxmlTree2MsrOahWithDetailedTrace;
...
#ifdef TRACE_OAH
void mxmlTree2MsrOah::initializeMxmlTree2MsrTraceOptions (
...
//______________________________________________________________________________
void mxmlTree2MsrOah::enforceGroupQuietness ()
{
  // specific trace JMI
  // --------------------------------------
}
...
//______________________________________________________________________________
void mxmlTree2MsrOah::checkGroupOptionsConsistency ()
{
#ifdef TRACE_OAH
  if (gGlobalTraceOahGroup->getTraceOah ()) {
    gLogOstream <<
  ...
  S_oahHandler handler)
{
  ...
  gGlobalMxmlTree2MsrOahUserChoices = mxmlTree2MsrOah::create (
    handler);
  assert(gGlobalMxmlTree2MsrOahUserChoices != 0);

  gGlobalMxmlTree2MsrOah =
    gGlobalMxmlTree2MsrOahUserChoices;

  // prepare for measure detailed trace
  // ------------------------------------------------------

/* JMI
  gGlobalMxmlTree2MsrOahWithDetailedTrace =
    gGlobalMxmlTree2MsrOah->
