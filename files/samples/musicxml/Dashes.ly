...
% Generated by xml2ly 0.93 from "spanners/Dashes.xml"
% on Saturday 2020-03-07 @ 15:13:58 CET

% The translation command line was:
%   xml2ly '-xi' '-aofn' '-dmsr' '-dpg' '--dlpsr' '-abn' '-lpcd' '-rbracks' '-mssp' '1cm' '-loop' 'spanners/Dashes.xml' '-t=notes,orns,spans'
% or, with long option names:
%  xml2ly spanners/Dashes.xml -xml2ly-infos -auto-output-file-name -display-msr -display-partgroups -display-lpsr -all-bar-numbers -lilypond-compile-date -repeat-brackets -markup-system-spacing.padding '1 cm' -loop-to-musicxml -trace-notes -trace-ornaments -trace-spanners
% or, with short option names:
%   xml2ly spanners/Dashes.xml -xi -aofn -dmsr -dpg -dlpsr -abn -lpcd -rbracks -mssp '1 cm' -loop -tnotes -torns -tspans
...
Part_POne_Staff_One_Voice_One = \absolute {
  ...
  %{ absoluteOctave = 4 %}
  c'1 \startTextSpan \startTextSpan | % 2
  \barNumberCheck #2
  
  %{ absoluteOctave = 4 %}
  g'1 \stopTextSpan \stopTextSpan | % 3
  \barNumberCheck #3
}
