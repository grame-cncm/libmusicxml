...
void brailleOutputKindAtom::handleValuedAtomValue (
  string   theString,
  ostream& os)
{
#ifdef TRACE_OAH
...
void brailleOutputKindAtom::printValuedAtomOptionsValues (
  ostream& os,
...
void brailleUTFKindAtom::handleValuedAtomValue (
  string   theString,
  ostream& os)
{
#ifdef TRACE_OAH
...
void brailleUTFKindAtom::printValuedAtomOptionsValues (
  ostream& os,
  int      valueFieldWidth) const
{
  os << left <<
...
void brailleByteOrderingKindAtom::handleValuedAtomValue (
  string   theString,
  ostream& os)
{
#ifdef TRACE_OAH
...
void brailleByteOrderingKindAtom::printValuedAtomOptionsValues (
  ostream& os,
  int      valueFieldWidth) const
{
  os << left <<
...
S_bsr2BrailleOah gGlobalBsr2BrailleOah;
S_bsr2BrailleOah gGlobalBsr2BrailleOahUserChoices;
S_bsr2BrailleOah gGlobalBsr2BrailleOahWithDetailedTrace;
...
//______________________________________________________________________________
void bsr2BrailleOah::enforceGroupQuietness ()
{}

//______________________________________________________________________________
void bsr2BrailleOah::checkGroupOptionsConsistency ()
{}
  ...
  S_oahHandler handler)
{
  ...
  if (! pThisMethodHasBeenRun) {
    ...
    gGlobalBsr2BrailleOahUserChoices = bsr2BrailleOah::create (
      handler);
    assert(gGlobalBsr2BrailleOahUserChoices != 0);

    gGlobalBsr2BrailleOah =
      gGlobalBsr2BrailleOahUserChoices;

    // prepare for measure detailed trace
    // ------------------------------------------------------

  /* JMI
    gGlobalBsr2BrailleOahWithDetailedTrace =
      gGlobalBsr2BrailleOah->
