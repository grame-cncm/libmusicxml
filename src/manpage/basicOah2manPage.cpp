...
//________________________________________________________________________
void basicOah2manPage::visitStart (S_oahAtomStoringAValueInAVariable& elt)
{
#ifdef TRACING_IS_ENABLED
  if (gGlobalOahOahGroup->getTraceOahVisitors ()) {
    gLogStream <<
...
void basicOah2manPage::visitEnd (S_oahAtomStoringAValueInAVariable& elt)
{
#ifdef TRACING_IS_ENABLED
  if (gGlobalOahOahGroup->getTraceOahVisitors ()) {
    gLogStream <<
...
//________________________________________________________________________
void basicOah2manPage::visitStart (S_oahAtomSynonym& elt)
{
#ifdef TRACING_IS_ENABLED
  if (gGlobalOahOahGroup->getTraceOahVisitors ()) {
    gLogStream <<
...
void basicOah2manPage::visitEnd (S_oahAtomSynonym& elt)
{
#ifdef TRACING_IS_ENABLED
  if (gGlobalOahOahGroup->getTraceOahVisitors ()) {
    gLogStream <<
...
//________________________________________________________________________
void basicOah2manPage::visitStart (S_oahMultiplexBooleansAtom& elt)
{
#ifdef TRACING_IS_ENABLED
  if (gGlobalOahOahGroup->getTraceOahVisitors ()) {
    gLogStream <<
...
void basicOah2manPage::visitEnd (S_oahMultiplexBooleansAtom& elt)
{
#ifdef TRACING_IS_ENABLED
  if (gGlobalOahOahGroup->getTraceOahVisitors ()) {
    gLogStream <<
...
//________________________________________________________________________
void basicOah2manPage::visitStart (S_oahMonoplexStringAtom& elt)
{
#ifdef TRACING_IS_ENABLED
  if (gGlobalOahOahGroup->getTraceOahVisitors ()) {
    gLogStream <<
...
void basicOah2manPage::visitEnd (S_oahMonoplexStringAtom& elt)
{
#ifdef TRACING_IS_ENABLED
  if (gGlobalOahOahGroup->getTraceOahVisitors ()) {
    gLogStream <<
