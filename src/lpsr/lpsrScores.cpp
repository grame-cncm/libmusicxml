  ...
  if (gGlobalLpsr2LilypondOah->fXml2lyInfos) {
    // create the 'input source name and translation date' comment
    {
      ...
      if (gGlobalOahOah->fInputSourceName == "-") {
        ...
        s << "\"" << gGlobalOahOah->fInputSourceName << "\"";
      }

      s <<
        endl <<
        "% on " << gGlobalGeneralOah->fTranslationDateFull <<
        endl;
    ...
    // create the 'command line as supplied' comment
    {
      ...
      s <<
        gTab <<
        gGlobalOahOah->fCommandLineAsSupplied;
    ...
    bool
      longAndShortOptionsDiffer =
        gGlobalOahOah->fCommandLineWithShortOptionsNames
          !=
        gGlobalOahOah->fCommandLineWithLongOptionsNames;
