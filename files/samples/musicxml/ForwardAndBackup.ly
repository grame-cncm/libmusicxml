...
% Generated by xml2ly 0.93 from "forward/ForwardAndBackup.xml"
% on Sunday 2020-04-26 @ 15:00:43 CEST

% The translation command line was:
%   xml2ly '-xi' '-aofn' '-dmsr' '-dpg' '--dlpsr' '-abn' '-lpcd' '-rbracks' '-mssp' '1cm' '-loop' 'forward/ForwardAndBackup.xml'
% or, with long option names:
%  xml2ly forward/ForwardAndBackup.xml -xml2ly-infos -auto-output-file-name -display-msr -display-partgroups -display-lpsr -all-bar-numbers -lilypond-compile-date -repeat-brackets -markup-system-spacing.padding '1 cm' -loop-to-musicxml
% or, with short option names:
%   xml2ly forward/ForwardAndBackup.xml -xi -aofn -dmsr -dpg -dlpsr -abn -lpcd -rbracks -mssp '1 cm' -loop
...
Part_POne_Staff_One_Voice_One = \absolute {
  ...
  \clef "treble"
  \grace { s%{44%}16  s%{44%}  s%{44%} } cis'''2  | % 1
  \barNumberCheck #2
}
...
Part_POne_Staff_One_Voice_Two = \absolute {
  ...
  \clef "treble"
  \grace { s%{44%}16  s%{44%}  s%{44%} }
  \arpeggioNormal <cis'' e'' a'' >4 -\arpeggio s%{44%} | % 1
  \barNumberCheck #2
}
...
Part_POne_Staff_Two_Voice_Three = \absolute {
  ...
  \clef "bass"
  \grace { a,16 [  cis16  e16 ] } a8 [ ( ) a a a ] | % 2
  \barNumberCheck #2
}
