...
S_lilypondGenerationOahGroup gGlobalLilypondGenerationOahGroup;

S_lilypondGenerationOahGroup lilypondGenerationOahGroup::create ()
{
  lilypondGenerationOahGroup* o = new lilypondGenerationOahGroup ();
  assert (o != nullptr);
  return o;
}

lilypondGenerationOahGroup::lilypondGenerationOahGroup ()
  : oahGroup (
      "Lpsr2lilyPond",
...
void lilypondGenerationOahGroup::initializeLilypondVersionOptions ()
{
  S_oahSubGroup
    subGroup =
      oahSubGroup::create (
...
void lilypondGenerationOahGroup::initializeScoreNotationOptions ()
{
  S_oahSubGroup
    subGroup =
      oahSubGroup::create (
...
void lilypondGenerationOahGroup::initializeGlobalStaffSizeOptions ()
{
  S_oahSubGroup
    subGroup =
      oahSubGroup::create (
...
void lilypondGenerationOahGroup::initializeIdentificationOptions ()
{
  S_oahSubGroup
    subGroup =
      oahSubGroup::create (
...
void lilypondGenerationOahGroup::initializePartsOptions ()
{
  S_oahSubGroup
    subGroup =
      oahSubGroup::create (
...
void lilypondGenerationOahGroup::initializeEngraversOptions ()
{
  S_oahSubGroup
    subGroup =
      oahSubGroup::create (
...
void lilypondGenerationOahGroup::initializeClefsKeysTimesOptions ()
{
  S_oahSubGroup
    subGroup =
      oahSubGroup::create (
...
void lilypondGenerationOahGroup::initializeNotesOptions ()
{
  S_oahSubGroup
    subGroup =
      oahSubGroup::create (
...
void lilypondGenerationOahGroup::initializeBarsOptions ()
{
  S_oahSubGroup
    subGroup =
      oahSubGroup::create (
...
void lilypondGenerationOahGroup::initializeLineBreaksOptions ()
{
  S_oahSubGroup
    subGroup =
      oahSubGroup::create (
...
void lilypondGenerationOahGroup::initializePageBreaksOptions ()
{
  S_oahSubGroup
    subGroup =
      oahSubGroup::create (
...
void lilypondGenerationOahGroup::initializeStavesOptions ()
{
  S_oahSubGroup
    subGroup =
      oahSubGroup::create (
...
void lilypondGenerationOahGroup::initializeChordsOptions ()
{
  S_oahSubGroup
    subGroup =
      oahSubGroup::create (
...
void lilypondGenerationOahGroup::initializeTupletsOptions ()
{
  S_oahSubGroup
    subGroup =
      oahSubGroup::create (
...
void lilypondGenerationOahGroup::initializeRepeatOptions ()
{
  S_oahSubGroup
    subGroup =
      oahSubGroup::create (
...
void lilypondGenerationOahGroup::initializeOrnamentsOptions ()
{
  S_oahSubGroup
    subGroup =
      oahSubGroup::create (
...
void lilypondGenerationOahGroup::initializeChordsDisplayOptions ()
{
  S_oahSubGroup
    subGroup =
      oahSubGroup::create (
...
void lilypondGenerationOahGroup::initializeLyricsOptions ()
{
  S_oahSubGroup
    subGroup =
      oahSubGroup::create (
...
void lilypondGenerationOahGroup::initializeFontsOptions ()
{
  S_oahSubGroup
    subGroup =
      oahSubGroup::create (
...
void lilypondGenerationOahGroup::initializeCodeGenerationOptions ()
{
  S_oahSubGroup
    subGroup =
      oahSubGroup::create (
...
void lilypondGenerationOahGroup::initializeMidiOptions ()
{
  S_oahSubGroup
    subGroup =
      oahSubGroup::create (
...
void lilypondGenerationOahGroup::initializeCombinedOptionsOptions ()
{
  S_oahSubGroup
    subGroup =
      oahSubGroup::create (
...
void lilypondGenerationOahGroup::initializeLilypondGenerationOahGroup ()
{
  // LilyPond version
  // --------------------------------------
...
/* JMI
bool lilypondGenerationOahGroup::setAccidentalStyleKind (lpsrAccidentalStyleKind accidentalStyleKind)
{
...
//______________________________________________________________________________
void lilypondGenerationOahGroup::crackLilypondVersionNumber (
  string theString,
...
bool lilypondGenerationOahGroup::versionNumberGreaterThanOrEqualTo (
...
//______________________________________________________________________________
void lilypondGenerationOahGroup::enforceGroupQuietness ()
{}

//______________________________________________________________________________
void lilypondGenerationOahGroup::checkGroupOptionsConsistency ()
{
  // JMI
}

//______________________________________________________________________________
void lilypondGenerationOahGroup::acceptIn (basevisitor* v)
{
#ifdef TRACING_IS_ENABLED
  if (gGlobalOahOahGroup->getTraceOahVisitors ()) {
    gLogStream <<
      ".\\\" ==> lilypondGenerationOahGroup::acceptIn ()" <<
      endl;
  }
#endif

  if (visitor<S_lilypondGenerationOahGroup>*
    p =
      dynamic_cast<visitor<S_lilypondGenerationOahGroup>*> (v)) {
        S_lilypondGenerationOahGroup elem = this;

#ifdef TRACING_IS_ENABLED
        if (gGlobalOahOahGroup->getTraceOahVisitors ()) {
          gLogStream <<
            ".\\\" ==> Launching lilypondGenerationOahGroup::visitStart ()" <<
            endl;
        }
#endif
        p->visitStart (elem);
...
void lilypondGenerationOahGroup::acceptOut (basevisitor* v)
{
#ifdef TRACING_IS_ENABLED
  if (gGlobalOahOahGroup->getTraceOahVisitors ()) {
    gLogStream <<
      ".\\\" ==> lilypondGenerationOahGroup::acceptOut ()" <<
      endl;
  }
#endif
  ...
  if (visitor<S_lilypondGenerationOahGroup>*
    p =
      dynamic_cast<visitor<S_lilypondGenerationOahGroup>*> (v)) {
        ...
        if (gGlobalOahOahGroup->getTraceOahVisitors ()) {
          gLogStream <<
            ".\\\" ==> Launching lilypondGenerationOahGroup::visitEnd ()" <<
            endl;
        }
#endif
        p->visitEnd (elem);
...
void lilypondGenerationOahGroup::browseData (basevisitor* v)
{
#ifdef TRACING_IS_ENABLED
  if (gGlobalOahOahGroup->getTraceOahVisitors ()) {
    gLogStream <<
      ".\\\" ==> lilypondGenerationOahGroup::browseData ()" <<
      endl;
  }
#endif
}

void lilypondGenerationOahGroup::printAtomWithVariableOptionsValues (
  ostream&     os,
  unsigned int valueFieldWidth) const
{
  os <<
...
void lilypondGenerationOahGroup::printLilypondGenerationOahValues (unsigned int fieldWidth)
{
  gLogStream <<
    "The LilyPond lilypond are:" <<
    endl;
...
ostream& operator<< (ostream& os, const S_lilypondGenerationOahGroup& elt)
{
  elt->print (os);
  return os;
}
...
//______________________________________________________________________________
S_lilypondGenerationOahGroup createGlobalLilypondGenerationOahGroup ()
{
#ifdef TRACING_IS_ENABLED
  ...
  if (! gGlobalLilypondGenerationOahGroup) {
    // create the global OAH group
    gGlobalLilypondGenerationOahGroup =
      lilypondGenerationOahGroup::create ();
    assert (gGlobalLilypondGenerationOahGroup != 0);
  }

  // return the global OAH group
  return gGlobalLilypondGenerationOahGroup;
}
