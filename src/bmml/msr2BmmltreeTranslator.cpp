...
msr2BmmltreeTranslator::msr2BmmltreeTranslator (
  ostream&   os,
  S_msrScore mScore)
    : fLogOutputStream (os)
{
  ...
  fScorePartWiseElement = createBmmlScorePartWiseElement ();
...
//________________________________________________________________________
void msr2BmmltreeTranslator::buildBmmltreeFromMsrScore ()
{
  if (fVisitedMsrScore) {
...
string msr2BmmltreeTranslator::msrLengthAsTenths (
  msrLength length)
{
...
string msr2BmmltreeTranslator::S_msrLengthAsTenths (
  S_msrLength length)
{
...
//______________________________________________________________________________
void msr2BmmltreeTranslator::populatePageMargins (
  Sxmlelement       elem,
...
void msr2BmmltreeTranslator::appendPageMarginsToScoreDefaultsPageLayout (
  S_msrMarginsGroup marginsGroup)
{
  // create a page margins element
  Sxmlelement
    pageMargins =
      createBmmlElement (k_page_margins, "");
...
//______________________________________________________________________________
void msr2BmmltreeTranslator::populateSystemMargins (
  Sxmlelement       elem,
...
void msr2BmmltreeTranslator::appendSystemMarginsToScoreDefaultsSystemLayout (
  S_msrSystemLayout systemLayout)
{
  // JMI
}
...
//______________________________________________________________________________
string msr2BmmltreeTranslator::msrPlacementKindAsMusicXMLString (
...
//______________________________________________________________________________
string msr2BmmltreeTranslator::msrSpannerTypeKindAsMusicXMLString (
...
//________________________________________________________________________
void msr2BmmltreeTranslator::appendToScoreWork (
  Sxmlelement elem)
{
  if (! fScoreWorkElement) {
    // create a work element
    fScoreWorkElement = createBmmlElement (k_work, "");
  }
...
//________________________________________________________________________
void msr2BmmltreeTranslator::appendToScoreIdentification (
  Sxmlelement elem)
{
  if (! fScoreIdentificationElement) {
    // create an identification element
    fScoreIdentificationElement = createBmmlElement (k_identification, "");
  }

  fScoreIdentificationElement->push (elem);
}

void msr2BmmltreeTranslator::appendToScoreIdentificationEncoding (
  Sxmlelement elem)
{
  if (! fScoreIdentificationEncodingElement) {
    // create an encoding element
    fScoreIdentificationEncodingElement = createBmmlElement (k_encoding, "");
  }
...
//________________________________________________________________________
void msr2BmmltreeTranslator::appendToScoreDefaults (
  Sxmlelement elem)
{
  if (! fScoreDefaultsElement) {
    // create a defaults element
    fScoreDefaultsElement = createBmmlElement (k_defaults, "");
  }

  fScoreDefaultsElement->push (elem);
}

void msr2BmmltreeTranslator::appendToScoreDefaultsPageLayout (
  Sxmlelement elem)
{
  if (! fScoreDefaultsPageLayoutElement) {
    // create a page layout element
    fScoreDefaultsPageLayoutElement = createBmmlElement (k_page_layout, "");
  }
...
//________________________________________________________________________
void msr2BmmltreeTranslator::createBmmlAttributesElementAndAppendItToMeasure ()
{
  if (gMsr2BmmltreeOah->fMusicXMLComments) {
    ...
    s <<
      ...
      "Attributes " <<
      " ===== ";
    Sxmlelement comment = createBmmlElement (kComment, s.str ());
  ...
  Sxmlelement
    attributesElement =
      createBmmlElement (k_attributes, "");
...
//________________________________________________________________________
void msr2BmmltreeTranslator::appendToMeasureDirection (
  Sxmlelement      elem,
  msrPlacementKind placementKind)
{
  if (gMsr2BmmltreeOah->fMusicXMLComments) {
  ...
  Sxmlelement directionElement = createBmmlElement (k_direction, "");
  ...
  if (placementString.size ()) {
    directionElement->add (createBmmlAttribute ("placement",  placementString));
  }
  ...
  Sxmlelement directionTypeElement = createBmmlElement (k_direction_type, "");
...
//________________________________________________________________________
void msr2BmmltreeTranslator::appendNoteToMeasure (
  S_msrNote   note,
  Sxmlelement elem)
{
#ifdef TRACE_OAH
...
void msr2BmmltreeTranslator::appendOtherToMeasure (
  Sxmlelement elem)
{
#ifdef TRACE_OAH
  int inputLineNumber =
...
//________________________________________________________________________
void msr2BmmltreeTranslator::appendToNoteNotations (
  Sxmlelement      elem,
  msrPlacementKind placementKind)
{
  if (! fCurrentNoteNotations) {
    // create an notations element
    fCurrentNoteNotations = createBmmlElement (k_notations, "");
  ...
  if (placementString.size ()) {
    elem->add (createBmmlAttribute ("placement", placementString));
  }
...
void msr2BmmltreeTranslator::appendToNoteNotationsOrnaments (
  Sxmlelement      elem,
  msrPlacementKind placementKind)
{
  if (! fCurrentNoteNotationsOrnaments) {
    // create an notations element
    fCurrentNoteNotationsOrnaments = createBmmlElement (k_ornaments, "");
...
//________________________________________________________________________
void msr2BmmltreeTranslator::appendToNoteNotationsArticulations (
  Sxmlelement      elem,
  msrPlacementKind placementKind)
{
  if (! fCurrentNoteNotationsArticulations) {
    // create the note notations articulations element
    fCurrentNoteNotationsArticulations = createBmmlElement (k_articulations, "");
...
//________________________________________________________________________
void msr2BmmltreeTranslator::appendToNoteNotationsTechnicals (
  Sxmlelement      elem,
  msrPlacementKind placementKind)
{
  if (! fCurrentNoteNotationsTechnicals) {
    // create an notations element
    fCurrentNoteNotationsTechnicals = createBmmlElement (k_technical, "");
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrScore& elt)
{
#ifdef TRACE_OAH
  int inputLineNumber =
  ...
  fScorePartWiseElement->push (createBmmlElement (kComment, s.str ()));
  ...
  fScorePartListElement = createBmmlElement (k_part_list, "");
}

void msr2BmmltreeTranslator::visitEnd (S_msrScore& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
  ...
  for (
    ...
    if (gMsr2BmmltreeOah->fMusicXMLComments) {
      ...
      s <<
        ...
        ", line " << inputLineNumber <<
        " ============================= ";
      Sxmlelement partComment = createBmmlElement (kComment, s.str ());
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrIdentification& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
  ...
  if (miscellaneousField) {
    ...
    miscellaneousFieldElement->add (
      createBmmlAttribute ("name", "description")); // ??? JMI sometines "comment"

    // create a miscellaneous element
    fIdentificationMiscellaneousElement = createBmmlElement (k_miscellaneous, "");
...
*/
  ...
  if (composers) {
    ...
    for (i=variableValuesList.begin (); i!=variableValuesList.end (); i++) {
      ...
      Sxmlelement creatorElement = createBmmlElement (k_creator, variableValue);

      // set its "type" attribute
      creatorElement->add (createBmmlAttribute ("type", "composer"));
  ...
  if (arrangers) {
    ...
    for (i=variableValuesList.begin (); i!=variableValuesList.end (); i++) {
      ...
      // set its "type" attribute
      creatorElement->add (createBmmlAttribute ("type", "arranger"));
  ...
  if (lyricists) {
    ...
    for (i=variableValuesList.begin (); i!=variableValuesList.end (); i++) {
      ...
      // set its "type" attribute
      creatorElement->add (createBmmlAttribute ("type", "lyricist"));
  ...
  if (poets) {
    ...
    for (i=variableValuesList.begin (); i!=variableValuesList.end (); i++) {
      ...
      // set its "type" attribute
      creatorElement->add (createBmmlAttribute ("type", "poet"));
  ...
  if (translators) {
    ...
    for (i=variableValuesList.begin (); i!=variableValuesList.end (); i++) {
      ...
      // set its "type" attribute
      creatorElement->add (createBmmlAttribute ("type", "translator"));
  ...
  if (artists) {
    ...
    for (i=variableValuesList.begin (); i!=variableValuesList.end (); i++) {
      ...
      // set its "type" attribute
      creatorElement->add (createBmmlAttribute ("type", "artist"));
...
void msr2BmmltreeTranslator::visitEnd (S_msrIdentification& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrScaling& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
  ...
  if (fMillimeters > 0) {
    ...
    fScoreDefaultsScalingElement = createBmmlElement (k_scaling, "");
...
void msr2BmmltreeTranslator::visitEnd (S_msrScaling& elt)
{
  gIndenter--;
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrPageLayout& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrPageLayout& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrSystemLayout& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
  ...
  Sxmlelement
    systemLayoutElement =
      createBmmlElement (k_system_layout, "");
  ...
  Sxmlelement
    systemMargins =
      createBmmlElement (k_system_margins, "");
...
void msr2BmmltreeTranslator::visitEnd (S_msrSystemLayout& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrStaffLayout& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
  ...
  Sxmlelement
    staffLayoutElement =
      createBmmlElement (k_staff_layout, "");

  // set its "number" attribute if relevant
  // (it is 0 inside the <defaults /> element)
  if (staffNumber > 0) {
    staffLayoutElement->add (createBmmlIntegerAttribute ("number", staffNumber));
  }
...
void msr2BmmltreeTranslator::visitEnd (S_msrStaffLayout& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrMeasureLayout& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
  ...
  if (fOnGoingPrintLayout) {
    ...
    Sxmlelement
      measureLayoutElement =
        createBmmlElement (k_measure_layout, "");
...
void msr2BmmltreeTranslator::visitEnd (S_msrMeasureLayout& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::populateAppearanceLineWidths (
  ...
  const list<S_msrLineWidth>& lineWidthsList)
{
  for (
    ...
    lineWidthElement->add (createBmmlAttribute ("type", lineWidthTypeString));
...
void msr2BmmltreeTranslator::populateAppearanceNoteSizes (
  Sxmlelement                appearanceElement,
  const list<S_msrNoteSize>& noteSizesList)
{
  for (
    ...
    noteSizeElement->add (createBmmlAttribute ("type", noteSizeTypeString));
...
void msr2BmmltreeTranslator::populateAppearanceDistances (
  Sxmlelement                appearanceElement,
  const list<S_msrDistance>& distancesList)
{
  for (
    ...
    distanceElement->add (createBmmlAttribute ("type", distanceTypeString));
...
void msr2BmmltreeTranslator::populateAppearanceGlyphs (
  Sxmlelement             appearanceElement,
  const list<S_msrGlyph>& glyphsList)
{
  for (
    ...
    glyphElement->add (createBmmlAttribute ("type", glyphTypeString));
...
void msr2BmmltreeTranslator::populateAppearanceOtherAppearances (
  Sxmlelement       appearanceElement,
                    ...
                    otherAppearancesList)
{
  for (
    ...
    otherAppearanceElement->add (createBmmlAttribute (
      "type",
...
void msr2BmmltreeTranslator::visitStart (S_msrAppearance& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
  ...
  fScoreDefaultsAppearanceElement =
    createBmmlElement (k_appearance, "");
...
void msr2BmmltreeTranslator::visitEnd (S_msrAppearance& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrCredit& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
  ...
  fCurrentScoreCredit = createBmmlElement (k_credit, "");

  // set its "page" attribute
  fCurrentScoreCredit->add (
    createBmmlIntegerAttribute ("page", elt->getCreditPageNumber ()));
...
void msr2BmmltreeTranslator::visitEnd (S_msrCredit& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitStart (S_msrCreditWords& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
  ...
  if (creditWordsDefaultX > 0.0) {
    ...
    creditWordsElement->add (createBmmlAttribute ("default-x", s.str ()));
  }
  ...
  if (creditWordsDefaultY > 0.0) {
    ...
    creditWordsElement->add (createBmmlAttribute ("default-y", s.str ()));
  }
  ...
  creditWordsElement->add (createBmmlAttribute ("font-size", s.str ()));
  ...
  if (fontWeightString.size ()) {
    creditWordsElement->add (createBmmlAttribute ("font-weight", fontWeightString));
  }
  ...
  if (fontStyleString.size ()) {
    creditWordsElement->add (createBmmlAttribute ("font-style", fontStyleString));
  }
  ...
  if (justifyString.size ()) {
    creditWordsElement->add (createBmmlAttribute ("justify", justifyString));
  }
  ...
  if (horizontalAlignmentString.size ()) {
    creditWordsElement->add (createBmmlAttribute ("halign", horizontalAlignmentString));
  }
  ...
  if (verticalAlignmentString.size ()) {
    creditWordsElement->add (createBmmlAttribute ("valign", verticalAlignmentString));
  }
...
void msr2BmmltreeTranslator::visitEnd (S_msrCreditWords& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrPartGroup& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
    ...
    case msrPartGroup::kPartGroupImplicitNo:
      {
        ...
        Sxmlelement scorePartGroupElement = createBmmlElement (k_part_group, "");

        // set it's "number" attribute
        scorePartGroupElement->add (
          createBmmlIntegerAttribute (
            "number", elt->getPartGroupNumber ()));

        // set it's "type" attribute
        scorePartGroupElement->add (createBmmlAttribute ("type", "start"));
...
void msr2BmmltreeTranslator::visitEnd (S_msrPartGroup& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
/* JMI ???
        ...
        if (elt != partGroupElementsStackTop) {
          s <<
            "elt " <<
            bmmlElementAsString (elt) <<
            " and partGroupElementsStackTop " <<
            bmmlElementAsString (partGroupElementsStackTop) <<
            " are different" <<
            ", line " << inputLineNumber;
...
*/
        ...
        // set it's "type" attribute
        scorePartGroupElement->add (createBmmlAttribute ("type", "stop"));
...
//________________________________________________________________________
int msr2BmmltreeTranslator::wholeNotesAsDivisions (
  int      inputLineNumber,
  rational wholeNotes)
{
  rational
...
void msr2BmmltreeTranslator::visitStart (S_msrPart& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
  ...
  Sxmlelement scorePartElement = createBmmlElement (k_score_part, "");
  // set it's "id" attribute
  scorePartElement->add (createBmmlAttribute ("id", partID));
  ...
  fCurrentPart = createBmmlElement (k_part, "");
  // set its "id" attribute
	fCurrentPart->add (createBmmlAttribute ("id", partID));
...
//      __FILE__, __LINE__,
  ...
  if (partStavesNumber > 1) {
    ...
    fStavesElement =
      createBmmlIntegerElement (
        k_staves,
        partStavesNumber);
  }
}

void msr2BmmltreeTranslator::visitEnd (S_msrPart& elt)
{
#ifdef TRACE_OAH
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrSegment& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber () ;
...
void msr2BmmltreeTranslator::visitEnd (S_msrSegment& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrMeasure& elt)
{
  int
    inputLineNumber =
      elt->getInputLineNumber ();
...
//      fCurrentVoiceClone->getVoiceName () <<
  ...
  if (it != fPartMeasuresMap.end ()) {
    ...
    fCurrentMeasure = createBmmlElement (k_measure, "");
    // set its "number" attribute
    fCurrentMeasure->add (createBmmlAttribute ("number", measureNumber));
  ...
  if (measurePrintLayout) {
    ...
    fCurrentPrint = createBmmlElement (k_print, "");
...
void msr2BmmltreeTranslator::visitEnd (S_msrMeasure& elt)
{
#ifdef TRACE_OAH
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrPrintLayout& elt)
{
#ifdef TRACE_OAH
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//      fCurrentVoiceClone->getVoiceName () <<
  ...
  if (staffSpacing > 0) {
    stringstream s;
    s << staffSpacing;
  	fCurrentPrint->add (createBmmlAttribute ("staff-spacing", s.str ()));
  }

  bool newSystem = elt->getNewSystem ();
  if (newSystem) {
  	fCurrentPrint->add (createBmmlAttribute ("new-system", "yes"));
  }

  bool newPage = elt->getNewPage ();
  if (newPage) {
  	fCurrentPrint->add (createBmmlAttribute ("new-page", "yes"));
  }
  ...
  if (blankPage > 0) {
    stringstream s;
    s << blankPage;
  	fCurrentPrint->add (createBmmlAttribute ("blank-page", s.str ()));
  }
  ...
  if (pageNumber > 0) {
    stringstream s;
    s << pageNumber;
  	fCurrentPrint->add (createBmmlAttribute ("page-number", s.str ()));
  }

  fOnGoingPrintLayout = true;
}

void msr2BmmltreeTranslator::visitEnd (S_msrPrintLayout& elt)
{
#ifdef TRACE_OAH
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrClef& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
  ...
  if (doAppendAClefElementToTheMeasure) {
    ...
    Sxmlelement clefElement = createBmmlElement (k_clef, "");

    // set its "number" attribute
    clefElement->add (
      createBmmlIntegerAttribute ("number", elt->getClefStaffNumber ()));
...
void msr2BmmltreeTranslator::visitEnd (S_msrClef& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrKey& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
  ...
  if (doAppendAKeyElementToTheMeasure) {
    ...
    fKeyElement = createBmmlElement (k_key, "");
...
void msr2BmmltreeTranslator::visitEnd (S_msrKey& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrTime& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
  ...
  if (doAppendATimeElementToTheMeasure) {
    ...
    fTimeElement = createBmmlElement (k_time, "");

    // populate it
    switch (elt->getTimeSymbolKind ()) {
      case msrTime::kTimeSymbolCommon:
        {
          fTimeElement->add (createBmmlAttribute ("symbol", "common"));
      ...
      case msrTime::kTimeSymbolCut:
         {
          fTimeElement->add (createBmmlAttribute ("symbol", "cut"));
...
void msr2BmmltreeTranslator::visitEnd (S_msrTime& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrTempo& elt)
{
#ifdef TRACE_OAH
  int inputLineNumber =
    elt->getInputLineNumber ();
    ...
    case msrTempo::kTempoBeatUnitsPerMinute:
      switch (tempoParenthesizedKind) {
        case msrTempo::kTempoParenthesizedYes:
          ...
          Sxmlelement metronomeElement = createBmmlElement (k_metronome, "");

          // set its "parentheses" attribute
          metronomeElement->add (createBmmlAttribute ("parentheses", "yes"));
          ...
          metronomeElement-> push (createBmmlElement (k_per_minute, tempoPerMinute));
...
void msr2BmmltreeTranslator::visitEnd (S_msrTempo& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrChord& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
  ...
  if (gMsr2BmmltreeOah->fMusicXMLComments) {
    ...
    s <<
      ...
      ", line " << inputLineNumber <<
      " ===== ";
    fPendingChordStartComment = createBmmlElement (kComment, s.str ());
  }
...
void msr2BmmltreeTranslator::visitEnd (S_msrChord& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrTuplet& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2BmmltreeTranslator::visitEnd (S_msrTuplet& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2BmmltreeTranslator:: appendNoteWedges (S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
    fLogOutputStream <<
  ...
  if (noteWedges.size ()) {
    ...
    for (i=noteWedges.begin (); i!=noteWedges.end (); i++) {
      ...
      Sxmlelement wedgeElement = createBmmlElement (k_wedge, "");

      // set its "type" attribute
      wedgeElement->add (createBmmlAttribute ("type", typeString));
...
//________________________________________________________________________
void msr2BmmltreeTranslator:: appendNoteDynamics (S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
    fLogOutputStream <<
  ...
  if (noteDynamics.size ()) {
    ...
    for (i=noteDynamics.begin (); i!=noteDynamics.end (); i++) {
      ...
      Sxmlelement dynamicsElement = createBmmlElement (k_dynamics, "");
      ...
      Sxmlelement dynamicsElementSubElement = createBmmlElement (subElementID, "");
...
//________________________________________________________________________
void msr2BmmltreeTranslator:: appendABackupToMeasure (S_msrNote note)
{
  int inputLineNumber =
  ...
  Sxmlelement backupElement = createBmmlElement (k_backup, "");

  // append a duration sub-element to it
  backupElement->push (
    createBmmlIntegerElement (k_duration, backupDurationDivisions));
...
//________________________________________________________________________
void msr2BmmltreeTranslator:: appendAForwardToMeasure (S_msrNote note)
{
  int inputLineNumber =
     note->getInputLineNumber ();
  ...
  */
  ...
  Sxmlelement forwardElement = createBmmlElement (k_forward, "");

  // append a duration sub-element to it
  forwardElement->push (
    createBmmlIntegerElement (k_duration, forwardDurationDivisions));

  // append a voice sub-element to it
  forwardElement->push (
    createBmmlIntegerElement (k_voice, noteVoiceNumber));

  // append a staff sub-element to it
  forwardElement->push (
    createBmmlIntegerElement (k_staff, noteStaffNumber));
...
//________________________________________________________________________
void msr2BmmltreeTranslator:: appendABackupOrForwardToMeasureIfNeeded (
  S_msrNote note)
{
#ifdef TRACE_OAH
  int inputLineNumber =
...
//________________________________________________________________________
void msr2BmmltreeTranslator:: populateNoteDirections (S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator:: appendNoteOrnaments (S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator:: appendNoteTechnicals (S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
    fLogOutputStream <<
...
<!ATTLIST technical
  ...
  if (noteTechnicals.size ()) {
    ...
    for (i=noteTechnicals.begin (); i!=noteTechnicals.end (); i++) {
      ...
      Sxmlelement technicalElement = createBmmlElement (technicalType, "");
...
//________________________________________________________________________
void msr2BmmltreeTranslator:: appendNoteTechnicalWithIntegers (
  S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
...
//________________________________________________________________________
void msr2BmmltreeTranslator:: appendNoteTechnicalWithFloats (
  S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
...
//________________________________________________________________________
void msr2BmmltreeTranslator:: appendNoteTechnicalWithStrings (
  S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
...
//________________________________________________________________________
void msr2BmmltreeTranslator:: appendNoteArticulations (S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
    fLogOutputStream <<
...
/* JMI
	((accent | strong-accent | staccato | tenuto |
	  ...
	  */
      ...
      Sxmlelement articulationElement = createBmmlElement (articulationType, "");
...
//________________________________________________________________________
void msr2BmmltreeTranslator:: appendNoteTieIfAny (
  S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
  ...
  if (noteTie) {
    ...
    Sxmlelement tiedElement = createBmmlElement (k_tied, "");
    ...
    if (typeString.size ()) {
      tiedElement->add (
        createBmmlAttribute ("type", typeString));
    }
...
//________________________________________________________________________
void msr2BmmltreeTranslator:: appendNoteSlursIfAny (
  S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
  ...
  if (noteSlurs.size ()) {
    ...
    for (i=noteSlurs.begin (); i!=noteSlurs.end (); i++) {
      ...
      Sxmlelement slurElement = createBmmlElement (k_slur, "");

      // create the slur number attribute
      int slurNumber = slur->getSlurNumber ();

      if (slurNumber > 0) {
        slurElement->add (createBmmlIntegerAttribute ("number", slurNumber));
      }
      ...
      if (slurTypeString.size ()) {
        slurElement->add (createBmmlAttribute ("type", slurTypeString));
      }
...
//________________________________________________________________________
void msr2BmmltreeTranslator:: appendNoteTupletIfRelevant (
  S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
    ...
    case msrNote::kTupletRestMemberNote:
      {
        ...
        if (typeString.size ()) {
          ...
          Sxmlelement tupletElement = createBmmlElement (k_tuplet, "");
...
//________________________________________________________________________
void msr2BmmltreeTranslator:: appendNoteSpannersBeforeNote (
  S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
  ...
  if (noteSpanners.size ()) {
    ...
    for (i=noteSpanners.begin (); i!=noteSpanners.end (); i++) {
      ...
      if (doHandleSpanner) {
        ...
        Sxmlelement spannerElement = createBmmlElement (spannerType, "");
        ...
        if (spannerNumber > 0) {
          spannerElement->add (createBmmlIntegerAttribute ("number", spannerNumber));
        }
        ...
        if (typeString.size ()) {
          spannerElement->add (createBmmlAttribute ("type", typeString));
        }
...
//________________________________________________________________________
void msr2BmmltreeTranslator:: appendNoteSpannersAfterNote (
  S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
...
//________________________________________________________________________
void msr2BmmltreeTranslator:: appendStemToNote (S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::appendBeamsToNote (S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
    fLogOutputStream <<
  ...
  if (noteBeams.size ()) {
    ...
    for (i=noteBeams.begin (); i!=noteBeams.end (); i++) {
      ...
      Sxmlelement beamElement = createBmmlElement (k_beam, beamString);

      // set its "number" attribute
      beamElement->add (createBmmlIntegerAttribute ("number", beam->getBeamNumber ()));
...
//________________________________________________________________________
void msr2BmmltreeTranslator:: appendStaffToNoteIfRelevant (S_msrNote note)
{
#ifdef TRACE_OAH
  int inputLineNumber =
    note->getInputLineNumber ();
...
//________________________________________________________________________
void msr2BmmltreeTranslator::appendVoiceToNoteIfRelevant (
  S_msrNote note)
{
#ifdef TRACE_OAH
  int inputLineNumber =
...
//________________________________________________________________________
void msr2BmmltreeTranslator:: appendNoteNotationsToNote (S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator:: appendNoteLyricsToNote (S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
    fLogOutputStream <<
  ...
  if (noteSyllables.size ()) {
    ...
    for (i=noteSyllables.begin (); i!=noteSyllables.end (); i++) {
      ...
      if (doCreateALyricElement) {
        ...
        Sxmlelement lyricElement = createBmmlElement (k_lyric, "");
        ...
        if (syllabicString.size ()) {
          lyricElement->push (
            createBmmlElement (k_syllabic, syllabicString));
        }
        ...
        if (doCreateAnExtendElement) {
          ...
          Sxmlelement extendElement = createBmmlElement (k_extend, "");

          if (extendTypeString.size ()) {
            // set its "type" attribute
            extendElement->add (createBmmlAttribute ("type", extendTypeString));
          }
...
//________________________________________________________________________
void msr2BmmltreeTranslator::appendBasicsToNote (
  S_msrNote note)
{
  int inputLineNumber =
    note->getInputLineNumber ();
  ...
  switch (noteKind) {
    case msrNote::kChordMemberNote:
      if (! note->getNoteIsAChordsFirstMemberNote ()) {
        fCurrentNote->push (createBmmlElement (k_chord, ""));
      }
      break;
    default:
      ;
  ...
  switch (noteKind) {
    case msrNote::kGraceNote:
    case msrNote::kGraceSkipNote:
      fCurrentNote->push (createBmmlElement (k_grace, ""));
      break;
    default:
      ;
  } // switch
  ...
  switch (noteKind) {
    ...
    case msrNote::kRestNote:
      fCurrentNote->push (createBmmlElement (k_rest, ""));
      break;
    ...
    case msrNote::kTupletMemberNote:
      {
        ...
        Sxmlelement pitchElement = createBmmlElement (k_pitch, "");
...
//________________________________________________________________________
void msr2BmmltreeTranslator::appendDurationToNoteIfRelevant (
  S_msrNote note)
{
  int inputLineNumber =
    note->getInputLineNumber ();
...
void msr2BmmltreeTranslator::appendTimeModificationToNoteIfRelevant (
  S_msrNote note)
{
#ifdef TRACE_OAH
  int inputLineNumber =
  ...
  switch (noteKind) {
    ...
    case msrNote::kTupletRestMemberNote:
      {
        Sxmlelement
          timeModificationElement = createBmmlElement (k_time_modification, "");
...
//________________________________________________________________________
void msr2BmmltreeTranslator::appendNoteToMesureIfRelevant (
  S_msrNote note)
{
#ifdef TRACE_OAH
  if (gTraceOah->fTraceNotes) {
  ...
  if (doGenerateNote) {
    ...
    fCurrentNote = createBmmlElement (k_note, "");
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrGraceNotesGroup& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber () ;
...
void msr2BmmltreeTranslator::visitEnd (S_msrGraceNotesGroup& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber () ;
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrNote& elt)
{
#ifdef TRACE_OAH
  int inputLineNumber =
    elt->getInputLineNumber ();
  ...
  if (fAnAttributeElementIsNeeded) {
    createBmmlAttributesElementAndAppendItToMeasure ();
...
void msr2BmmltreeTranslator::visitEnd (S_msrNote& elt)
{
#ifdef TRACE_OAH
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrBarline& elt)
{
#ifdef TRACE_OAH
  int inputLineNumber =
    elt->getInputLineNumber ();
  ...
  if (barLStyleString.size ()) {
    ...
    Sxmlelement barStyleElement = createBmmlElement (k_bar_style, barLStyleString);

    // create the barline element
    Sxmlelement barlineElement = createBmmlElement (k_barline, "");
    ...
    if (barLineLocationString.size ()) {
      barlineElement->add (createBmmlAttribute ("location", barLineLocationString));
    }
...
void msr2BmmltreeTranslator::visitEnd (S_msrBarline& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
/*
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrStaffLinesNumber& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrStaffTuning& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrStaffDetails& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrStaffDetails& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrStaff& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrStaff& elt)
{
  gIndenter--;
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrVoice& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2BmmltreeTranslator::visitEnd (S_msrVoice& elt)
{
  gIndenter--;
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrVoiceStaffChange& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrHarmony& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitStart (S_msrHarmonyDegree& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrHarmony& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrFrame& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrFiguredBass& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitStart (S_msrFigure& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrFiguredBass& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
/*
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrStanza& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrStanza& elt)
{
  gIndenter--;
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrSyllable& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2BmmltreeTranslator::visitEnd (S_msrSyllable& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrTranspose& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrTranspose& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrPartNameDisplay& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrPartAbbreviationDisplay& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrRehearsal& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrRehearsal& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrFermata& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrArpeggiato& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrNonArpeggiato& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrTechnical& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrTechnical& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrTechnicalWithInteger& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrTechnicalWithInteger& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrTechnicalWithFloat& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrTechnicalWithFloat& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrTechnicalWithString& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrTechnicalWithString& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrOrnament& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrOrnament& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrGlissando& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrGlissando& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrSlide& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrSlide& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrSingleTremolo& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrSingleTremolo& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrDoubleTremolo& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrDoubleTremolo& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrDynamics& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrDynamics& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrOtherDynamics& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrOtherDynamics& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrWords& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2BmmltreeTranslator::visitEnd (S_msrWords& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrSlur& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrSlur& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrLigature& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrLigature& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrSlash& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrWedge& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrWedge& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
/*
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrOctaveShift& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrOctaveShift& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrAccordionRegistration& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrHarpPedalsTuning& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrStem& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrStem& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrBeam& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrBeam& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrTie& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrTie& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrSegno& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitStart (S_msrDalSegno& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2BmmltreeTranslator::visitStart (S_msrCoda& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrEyeGlasses& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitStart (S_msrScordatura& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitStart (S_msrPedal& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitStart (S_msrDamp& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitStart (S_msrDampAll& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrBarCheck& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrBarCheck& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrBarNumberCheck& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrBarNumberCheck& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrLineBreak& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrLineBreak& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrPageBreak& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrPageBreak& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrRepeat& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2BmmltreeTranslator::visitEnd (S_msrRepeat& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrRepeatCommonPart& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2BmmltreeTranslator::visitEnd (S_msrRepeatCommonPart& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrRepeatEnding& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2BmmltreeTranslator::visitEnd (S_msrRepeatEnding& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrRestMeasures& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2BmmltreeTranslator::visitEnd (S_msrRestMeasures& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrRestMeasuresContents& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2BmmltreeTranslator::visitEnd (S_msrRestMeasuresContents& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrMeasuresRepeat& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2BmmltreeTranslator::visitEnd (S_msrMeasuresRepeat& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrMeasuresRepeatPattern& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2BmmltreeTranslator::visitEnd (S_msrMeasuresRepeatPattern& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrMeasuresRepeatReplicas& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
void msr2BmmltreeTranslator::visitEnd (S_msrMeasuresRepeatReplicas& elt)
{
  int inputLineNumber =
    elt->getInputLineNumber ();
...
//________________________________________________________________________
void msr2BmmltreeTranslator::visitStart (S_msrMidiTempo& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
void msr2BmmltreeTranslator::visitEnd (S_msrMidiTempo& elt)
{
#ifdef TRACE_OAH
  if (gMsrOah->fTraceMsrVisitors) {
    fLogOutputStream <<
...
/*
//________________________________________________________________________
void msr2BmmltreeTranslator::displayCurrentOnGoingValues ()
{
  fLogOutputStream <<
    "Ongoing value:" <<
    endl;
