...
S_msdl2xmlRegularHandler msdl2xmlRegularHandler::create (
              ...
              insiderOahHandler)
{
  ...
  msdl2xmlRegularHandler* o = new
    msdl2xmlRegularHandler (
      executableName,
      handlerHeader,
      insiderOahHandler);
  assert (o!=0);
...
msdl2xmlRegularHandler::msdl2xmlRegularHandler (
  string      executableName,
  string      handlerHeader,
  S_msdl2xmlInsiderHandler
              insiderOahHandler)
...
void msdl2xmlRegularHandler::createRegularHandlerGroups ()
{
#ifdef TRACING_IS_ENABLED
  if (getTraceOah ()) {
    gLogStream <<
...
void msdl2xmlRegularHandler::createInformationsRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::createFilesRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::createOahRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::createWarningAndErrorsRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::createInputRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::createPresentationRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::createPartsRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::createStavesRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::createVoicesRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::createClefsRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::createKeysRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::createTimesRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::createMeasuresRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::createRestsRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::createNotesRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::creatBeamsRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::createArticulationsRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::createOrnamentsRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::createGraceNotesRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::createChordsRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::createTiesRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::createSlursRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::createLigaturesRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::createDynamicsRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::createWedgesRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::createTupletsRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::createLyricsRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::createHarmoniesRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::createFiguredBassesRegularGroup ()
{
  // group
...
void msdl2xmlRegularHandler::createOutputRegularGroup ()
{
  // group
  ...
  registerAtomInRegularSubgroup ("msdl2xml-infos", subGroup);
  registerAtomInRegularSubgroup ("musicxml-comments", subGroup);
}

//______________________________________________________________________________
void msdl2xmlRegularHandler::checkOptionsAndArgumentsFromArgcAndArgv () const
{
#ifdef TRACING_IS_ENABLED
  if (getTraceOah ()) {
    gLogStream <<
...
//______________________________________________________________________________
void msdl2xmlRegularHandler::print (ostream& os) const
{
  const unsigned int fieldWidth = 27;

  os <<
    "msdl2xmlRegularHandler '" << fHandlerHeader << "':" <<
    endl;
...
ostream& operator<< (ostream& os, const S_msdl2xmlRegularHandler& elt)
{
  elt->print (os);
  return os;
}
