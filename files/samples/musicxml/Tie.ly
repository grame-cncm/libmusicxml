...
% Generated by xml2ly 0.93 from "basic/Tie.xml"
% on Friday 2020-03-13 @ 14:13:37 CET

% The translation command line was:
%   xml2ly '-xi' '-aofn' '-dmsr' '-dpg' '--dlpsr' '-abn' '-lpcd' '-rbracks' '-mssp' '1cm' '-loop' 'basic/Tie.xml' '-t=notes'
% or, with long option names:
%  xml2ly basic/Tie.xml -xml2ly-infos -auto-output-file-name -display-msr -display-partgroups -display-lpsr -all-bar-numbers -lilypond-compile-date -repeat-brackets -markup-system-spacing.padding '1 cm' -loop-to-musicxml -trace-notes
% or, with short option names:
%   xml2ly basic/Tie.xml -xi -aofn -dmsr -dpg -dlpsr -abn -lpcd -rbracks -mssp '1 cm' -loop -tnotes
