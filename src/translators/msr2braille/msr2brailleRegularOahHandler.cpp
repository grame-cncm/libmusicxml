...
void msr2brailleRegularOahHandler::createRegularHandlerGroups ()
{
#ifdef TRACING_IS_ENABLED
#ifdef ENFORCE_TRACE_OAH
  gLogStream <<
...
void msr2brailleRegularOahHandler::createOahRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createInformationsRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createWarningAndErrorsRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createPresentationRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createInputRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createFilesRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createPartsRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createStavesRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createVoicesRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createTranspositionsRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createClefsRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createKeysRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createTimesRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createRestsRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createNotesRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::creatBeamsRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createArticulationsRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createOrnamentsRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createGraceNotesRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createChordsRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createTiesRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createSlursRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createLigaturesRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createDynamicsRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createWedgesRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createTupletsRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createStringsRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createTablaturesRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createHarmoniesRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createFiguredBassesRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createLyricsRegularGroup ()
{
  // group
...
void msr2brailleRegularOahHandler::createOutputRegularGroup ()
{
  // group
...
//______________________________________________________________________________
void msr2brailleRegularOahHandler::checkOptionsAndArgumentsFromArgcAndArgv () const
{
#ifdef TRACING_IS_ENABLED
...
//______________________________________________________________________________
void msr2brailleRegularOahHandler::print (ostream& os) const
{
  const unsigned int fieldWidth = 27;

  os <<
    "msr2brailleRegularOahHandler '" << fHandlerHeader << "':" <<
    endl;
...
ostream& operator<< (ostream& os, const S_msr2brailleRegularOahHandler& elt)
{
  elt->print (os);
  return os;
}
