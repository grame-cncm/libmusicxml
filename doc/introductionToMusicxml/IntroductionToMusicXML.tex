...
Note elements can have stems and beams attached to them, as in:
\begin{lstlisting}[language=XML]
      <note>
        <pitch>
          <step>A</step>
...
A repeat barline is implicit at the beginning of the voices if not present, as is the case is usual score editions.

% -------------------------------------------------------------------------
\subsection{A repeat example}
% -------------------------------------------------------------------------

Here is a simple example in \mxmlfile{repeats/SimpleRepeatWithAnacrusis.xml}. We have abbreviated some elements for shortness:\\
