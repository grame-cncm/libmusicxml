...
void msrVoice::moveVoiceInitialElementsToCommonPart (
  int                   inputLineNumber,
...
void msrVoice::moveVoiceLastSegmentToCommonPart (
  int                   inputLineNumber,
  S_msrRepeatCommonPart repeatCommonPart,
  string                context)
{
  ...
  if (gGeneralOptions->fTraceRepeats) {
    gLogIOstream <<
      "Append the voice last segment to repeat common part '" <<
      repeatCommonPart->asShortString () <<
      "' in voice \"" <<
      getVoiceName () <<
      "\"" <<
...
void msrVoice::moveAllVoiceContentsToCommonPart (
  int                   inputLineNumber,
  S_msrRepeatCommonPart repeatCommonPart,
  string                context)
{
  moveVoiceInitialElementsToCommonPart (
    inputLineNumber,
    repeatCommonPart,
    context);
    
  moveVoiceLastSegmentToCommonPart (
    inputLineNumber,
    repeatCommonPart,
    context);
}
      ...
      if (fVoiceLastSegment) {
        ...
        if (voiceLastSegmentMeasuresList.size ()) {
          ...
          if (
            ...
            gLogIOstream <<
              endl <<
              "*********>> Current voice handleRepeatStartInVoiceClone() 1 \"" <<
              getVoiceName () <<
              "\"" <<
              ", line " << inputLineNumber <<
              " contains:" <<
...
*/
          ...
          if (
            ...
            gLogIOstream <<
              endl <<
              "*********>> Current voice handleRepeatStartInVoiceClone() 2 \"" <<
              getVoiceName () <<
              "\"" <<
              ", line " << inputLineNumber <<
              " contains:" <<
  ...
  switch (fVoiceKind) {
    ...
    case msrVoice::kFiguredBassVoice:
      {              
        ...
        if (fVoiceRepeatsStack.size () > 1) {
          // yes, this repeat in nested

          // move all the voice contents to the new repeat common part
          moveAllVoiceContentsToCommonPart (
            inputLineNumber,
            repeatCommonPart,
            "end of voice clone level repeat");
        }
        
        else {
          // no, this is a voice-level repeat
          ...
          if (gGeneralOptions->fTraceRepeats) {
            gLogIOstream <<
              "Appending current repeat '" <<
              currentRepeat->asString () <<
    ...
    case msrVoice::kFiguredBassVoice:
      {
        ...
        if (
          ...
          gLogIOstream <<
            endl <<
            "*********>> Current voice handleRepeatEndInVoice() 1 \"" <<
            getVoiceName () <<
            "\"" <<
            ", line " << inputLineNumber <<
            " contains:" <<
        ...
        if (fVoiceRepeatsStack.size ()) {
          ...
          moveAllVoiceContentsToCommonPart (
            inputLineNumber,
            repeatCommonPart,
            "containing repeat upon its end");
        }
...
#ifdef TRACE_OPTIONS
        if (gGeneralOptions->fTraceRepeatsDetails) {
          gLogIOstream <<
            "Pushing new repeat '" <<
        ...
        if (
          ...
          gLogIOstream <<
            endl <<
            "*********>> Current voice handleRepeatEndInVoice() 2 \"" <<
            getVoiceName () <<
            "\"" <<
            ", line " << inputLineNumber <<
            " contains:" <<
  ...
  int inputLineNumber)
{
  ...
  if (gGeneralOptions->fTraceRepeats) {
    gLogIOstream <<
      "Handling a repeat ending start voice \"" <<
      getVoiceName () <<
      "\"" <<
      ", line " << inputLineNumber <<
      endl;
    ...
    case msrVoice::kFiguredBassVoice:
      {
        ...
        if (
          ...
          gLogIOstream <<
            endl <<
            "*********>> Current voice handleRepeatEndingStartInVoice() 1 \"" <<
            getVoiceName () <<
            "\"" <<
            ", line " << inputLineNumber <<
            " contains:" <<
...
/* JMI
        ...
        if (gGeneralOptions->fTraceRepeats) {
          gLogIOstream <<
            "Handling a repeat upon its repeat ending start in voice \"" <<
            getVoiceName () <<
            "\"" <<
            ", line " << inputLineNumber <<
            endl;
        ...
        switch (fVoiceRepeatsStack.size ()) {
          case 0:
            {
              // this the first ending of a voice-level repeat
              ...
              s1 <<
                "Creating a repeat upon its first ending in voice \"" <<
                getVoiceName () <<
                "\"" <<
                ", line " << inputLineNumber;
      ...
      */
...
#ifdef TRACE_OPTIONS
              if (gGeneralOptions->fTraceRepeats) {
                displayVoiceRepeatsStack ("handleRepeatEndingStartInVoice() 2");
              }
#endif
            }
          break;
        ...
        if (
          ...
          gLogIOstream <<
            endl <<
            "*********>> Current voice handleRepeatEndingStartInVoice() 2 \"" <<
            getVoiceName () <<
            "\"" <<
            ", line " << inputLineNumber <<
            " contains:" <<
    ...
    case msrVoice::kFiguredBassVoice:
      {
        ...
        if (
          ...
          gLogIOstream <<
            endl <<
            "*********>> Current voice handleRepeatEndingStartInVoiceClone() 1 \"" <<
            getVoiceName () <<
            "\"" <<
            ", line " << inputLineNumber <<
            " contains:" <<
...
/* JMI
        ...
        if (gGeneralOptions->fTraceRepeats) {
          gLogIOstream <<
            "Handling a repeat upon its repeat ending start in voice clone \"" <<
            getVoiceName () <<
            "\"" <<
            ", line " << inputLineNumber <<
            endl;
          ...
          case 0:
            {
              ...
              s1 <<
                "Creating a repeat upon its first ending in voice clone \"" <<
                getVoiceName () <<
                "\"" <<
                ", line " << inputLineNumber;
              ...
              if (gGeneralOptions->fTraceSegments || gGeneralOptions->fTraceVoices) {
                gLogIOstream <<
                  "Creating a new last segment with the first ending measure for voice clone \"" <<
                  fVoiceName << "\"" <<
                  ", line " << inputLineNumber <<
                  endl;
              }
          ...
          case 1:
            {
              ...
              if (gGeneralOptions->fTraceRepeats) {
                gLogIOstream <<
                  "Append the voice last segment to the repeat common part in voice clone \"" <<
                  getVoiceName () <<
                  "\"" <<
                  ", line " << inputLineNumber <<
                  endl;
      ...
      */
...
#ifdef TRACE_OPTIONS
              if (gGeneralOptions->fTraceRepeats) {
                displayVoiceRepeatsStack ("handleRepeatEndingStartInVoiceClone() 2");
              }
#endif
            }
          break;
        ...
        if (
          ...
          gLogIOstream <<
            endl <<
            "*********>> Current voice handleRepeatEndingStartInVoiceClone() 2 \"" <<
            getVoiceName () <<
            "\"" <<
            ", line " << inputLineNumber <<
            " contains:" <<
  ...
  string context)
{
  ...
  fVoiceRepeatsStack.push_front (result);
  ...
  string      context)
{
  ...
  if (gGeneralOptions->fTraceRepeats) {
    gLogIOstream <<
      "Creating a repeat clone and stacking it in voice \"" <<
      getVoiceName () <<
      "\"" <<
      " (" << context << ")" <<
      ", line " << inputLineNumber <<
...
#ifdef TRACE_OPTIONS
  if (gGeneralOptions->fTraceRepeats) {
    displayVoiceRepeatsStack ("createARepeatCloneAndStackIt()");
  }
#endif
  ...
  string    repeatEndingNumber) // may be "1, 2"
{
  ...
  if (gGeneralOptions->fTraceRepeats) {
    gLogIOstream <<
      "Appending a hooked repeat ending to voice \"" <<
      getVoiceName () <<  "\"" <<
      ", line " << inputLineNumber <<
      endl;
...
*/
 ...
 // JMI fVoiceLastSegment = nullptr;
  ...
  displayVoiceRepeatsStack ("before adddding a hooked repeat ending to current repeat");

//     currentRepeat-> JMI
  fVoiceRepeatsStack.front ()->
    addRepeatEnding (repeatEnding);

  displayVoiceRepeatsStack ("after adddding a hooked repeat ending to current repeat");
  ...
  string    repeatEndingNumber) // may be "1, 2"
{
  ...
  if (gGeneralOptions->fTraceRepeats) {
    gLogIOstream <<
      "Appending a hookless repeat ending to voice \"" <<
      getVoiceName () <<  "\"" <<
      ", line " << inputLineNumber <<
      endl;
...
*/
 ...
 // JMI fVoiceLastSegment = nullptr;
  ...
  displayVoiceRepeatsStack ("before adddding a hookless repeat ending to current repeat");

  currentRepeat->
    addRepeatEnding (repeatEnding);

  displayVoiceRepeatsStack ("after adddding a hookless repeat ending to current repeat");

  // append currentRepeat to the list of initial elements
#ifdef TRACE_OPTIONS
  if (gGeneralOptions->fTraceRepeats) {
    gLogIOstream <<
      "Appending currentRepeat '" <<
      currentRepeat->asString () <<
      "' to the initial elements in voice \"" <<
      getVoiceName () <<
      "\"" <<
            ...
            repeatEndingKind)
{
  ...
  if (
    ...
    gLogIOstream <<
      endl <<
      "*********>> Current voice appendRepeatEndingToVoice() 1 \"" <<
      getVoiceName () <<
      "\"" <<
      ", line " << inputLineNumber <<
      " contains:" <<
  ...
  string    repeatEndingNumber) // may be "1, 2"
{
  ...
  if (gGeneralOptions->fTraceRepeats) {
    gLogIOstream <<
      "Appending a hooked repeat ending to voice clone \"" <<
      getVoiceName () <<  "\"" <<
      ", line " << inputLineNumber <<
      endl;
  ...
  string    repeatEndingNumber) // may be "1, 2"
{
  ...
  if (gGeneralOptions->fTraceRepeats) {
    gLogIOstream <<
      "Appending a hookless repeat ending to voice clone \"" <<
      getVoiceName () <<  "\"" <<
      ", line " << inputLineNumber <<
      endl;
            ...
            repeatEndingKind)
{
  ...
  if (
    ...
    gLogIOstream <<
      endl <<
      "*********>> Current voice appendRepeatEndingToVoiceClone() 1 \"" <<
      getVoiceName () <<
      "\"" <<
      ", line " << inputLineNumber <<
      " contains:" <<
