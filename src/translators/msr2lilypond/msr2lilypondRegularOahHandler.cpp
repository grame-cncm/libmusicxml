...
S_msr2lilypondRegularOahHandler msr2lilypondRegularOahHandler::create (
              ...
              insiderOahHandler)
{
  ...
  msr2lilypondRegularOahHandler* o = new
...
msr2lilypondRegularOahHandler::msr2lilypondRegularOahHandler (
  string      executableName,
  string      executableAboutInformation,
  string      handlerHeader,
  S_msr2lilypondInsiderOahHandler
...
void msr2lilypondRegularOahHandler::createRegularHandlerGroups ()
{
#ifdef TRACING_IS_ENABLED
#ifdef ENFORCE_TRACE_OAH
  gLogStream <<
...
void msr2lilypondRegularOahHandler::createOahRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createInformationsRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createWarningAndErrorsRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createInputRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createFilesRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createPartsRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createStavesRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createVoicesRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createTranspositionsRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createClefsRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createKeysRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createTimesRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createRepeatsRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createMeasuresRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createRestsRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createNotesRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::creatBeamsRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createArticulationsRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createOrnamentsRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createGraceNotesRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createChordsRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createTiesRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createSlursRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createLigaturesRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createDynamicsRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createWedgesRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createTupletsRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createStringsRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createTablaturesRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createHarmoniesRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createFiguredBassesRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createLyricsRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createBookRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createHeaderRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createPaperRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createLayoutRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createOutputRegularGroup ()
{
  // group
...
void msr2lilypondRegularOahHandler::createMidiRegularGroup ()
{
  // group
...
//______________________________________________________________________________
void msr2lilypondRegularOahHandler::checkOptionsAndArgumentsFromArgcAndArgv () const
{
#ifdef TRACING_IS_ENABLED
...
//______________________________________________________________________________
void msr2lilypondRegularOahHandler::print (ostream& os) const
{
  const unsigned int fieldWidth = 27;

  os <<
    "msr2lilypondRegularOahHandler '" << fHandlerHeader << "':" <<
    endl;
...
ostream& operator<< (ostream& os, const S_msr2lilypondRegularOahHandler& elt)
{
  elt->print (os);
  return os;
}
