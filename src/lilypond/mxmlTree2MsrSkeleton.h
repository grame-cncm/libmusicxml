...
#ifndef __musicXMLTree2MsrSkeleton__
#define __musicXMLTree2MsrSkeleton__
...
*/
class EXP musicXMLTree2MsrSkeleton : 
...

{
  public:
    ...
    virtual ~musicXMLTree2MsrSkeleton ();

    S_msrScore buildMsrSkeletonFromXMLElementTree (
