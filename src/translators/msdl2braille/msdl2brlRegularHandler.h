...
#ifndef ___msdl2brlRegularHandler___
#define ___msdl2brlRegularHandler___
...
class EXP msdl2brlRegularHandler : public oahRegularHandler
/*
  An msdl2brl regular OAH handler can rely on the existence of an insider handler,
...
*/
{
  public:
    ...
    static SMARTP<msdl2brlRegularHandler> create (
  ...
  protected:
    ...
    virtual               ~msdl2brlRegularHandler ();
...
typedef SMARTP<msdl2brlRegularHandler> S_msdl2brlRegularHandler;
EXP ostream& operator<< (ostream& os, const S_msdl2brlRegularHandler& elt);
