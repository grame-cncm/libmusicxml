...
% Generated by xml2ly 0.92 from "../musicxml/harmonies/Inversion.xml"
% on Saturday 2020-01-18 @ 04:44:21 CET

% The translation command line was:
%   xml2ly '-xi' '-aofn' '-dmsr' '-dpg' '--dlpsr' '-abn' '-lpcd' '../musicxml/harmonies/Inversion.xml'
% or, with long option names:
%  xml2ly ../musicxml/harmonies/Inversion.xml -xml2ly-infos -auto-output-file-name -display-msr -display-partgroups -display-lpsr -all-bar-numbers -lilypond-compile-date
% or, with short option names:
%   xml2ly ../musicxml/harmonies/Inversion.xml -xi -aofn -dmsr -dpg -dlpsr -abn -lpcd
...
Part_POne_Staff_One_Voice_One_HARMONY = \chordmode {
  \language "nederlands"
...
\book {
  ...
  \score {
    <<
      ...
      \context ChordNames = "Part_POne_Staff_One_Voice_One_HARMONY"
      \Part_POne_Staff_One_Voice_One_HARMONY
