  ...
  int inputLineNumber) const
{
  ...
  if (
    gGlobalTraceOah->fTraceMeasures
      ||
    gGlobalTraceOah->fTraceSegments
      ||
    gGlobalTraceOah->fTraceRepeats
  ) {
    fSegmentVoiceUpLink->
...
{
#ifdef TRACE_OAH
  if (gGlobalTraceOah->fTraceSegnos) {
    gLogOstream <<
      "Appending segno " <<
      " to segment " << asString () <<
      "' in voice \"" <<
...
{
#ifdef TRACE_OAH
  if (gGlobalTraceOah->fTraceCodas) {
    gLogOstream <<
      "Appending coda " <<
      " to segment " << asString () <<
      "' in voice \"" <<
...
{
#ifdef TRACE_OAH
  if (gGlobalTraceOah->fTraceEyeGlasses) {
    gLogOstream <<
...
{
#ifdef TRACE_OAH
  if (gGlobalTraceOah->fTraceDamps) {
    gLogOstream <<
      "Appending damp " <<
      " to segment " << asString () <<
      "' in voice \"" <<
...
{
#ifdef TRACE_OAH
  if (gGlobalTraceOah->fTraceDampAlls) {
    gLogOstream <<
      "Appending damp all " <<
      " to segment " << asString () <<
      "' in voice \"" <<
  ...
  S_msrStaffDetails staffDetails)
{
  ...
  if (
    gGlobalTraceOah->fTraceStaffDetails
      ||
    gGlobalTraceOah->fTraceSegments
  ) {
    gLogOstream <<
...
{
#ifdef TRACE_OAH
  if (gGlobalTraceOah->fTraceLineBreaks) {
    gLogOstream <<
      "Appending break '" <<
...
{
#ifdef TRACE_OAH
  if (gGlobalTraceOah->fTracePageBreaks) {
    gLogOstream <<
      "Appending break " <<
      " to segment " << asString () <<
      "' in voice \"" <<
...
{
#ifdef TRACE_OAH
  if (gGlobalTraceOah->fTraceBarNumberChecks) {
    gLogOstream <<
...
{
#ifdef TRACE_OAH
  if (gGlobalTraceOah->fTraceRehearsals) {
    gLogOstream <<
      "Appending rehearsal " <<
      " to segment " << asString () <<
      "' in voice \"" <<
...
{
#ifdef TRACE_OAH
  if (gGlobalTraceOah->fTraceOctaveShifts) {
    gLogOstream <<
...
{
#ifdef TRACE_OAH
  if (gGlobalTraceOah->fTraceScordaturas) {
    gLogOstream <<
...
{
#ifdef TRACE_OAH
  if (gGlobalTraceOah->fTraceBarChecks) {
    gLogOstream <<
