...
% Generated by xml2ly 0.93 from "backup/BackupInOrganPart.xml"
% on Thursday 2020-04-16 @ 08:11:01 CEST

% The translation command line was:
%   xml2ly '-xi' '-aofn' '-dmsr' '-dpg' '--dlpsr' '-abn' '-lpcd' '-rbracks' '-mssp' '1cm' '-loop' 'backup/BackupInOrganPart.xml' '-t=mxmltv'
% or, with long option names:
%  xml2ly backup/BackupInOrganPart.xml -xml2ly-infos -auto-output-file-name -display-msr -display-partgroups -display-lpsr -all-bar-numbers -lilypond-compile-date -repeat-brackets -markup-system-spacing.padding '1 cm' -loop-to-musicxml -trace-musicxml-tree-visitors
% or, with short option names:
%   xml2ly backup/BackupInOrganPart.xml -xi -aofn -dmsr -dpg -dlpsr -abn -lpcd -rbracks -mssp '1 cm' -loop -tmxmltv
...
Part_POne_Staff_Two_Voice_Five = \absolute {
  ...
  b,2. | % 1
  \barNumberCheck #1
  b,8 [ b, b, ] cis4. r%{2%}4 | % 2
  \barNumberCheck #2
  dis8 [ dis dis ] e4. r%{2%}4 | % 0
  \barNumberCheck #3
}
