...
% Generated by xml2ly 0.93 from "Chords_LOOP.xml"
% on Thursday 2020-03-05 @ 14:45:39 CET

% The translation command line was:
%   xml2ly '-xi' '-aofn' '-dmsr' '-dpg' '--dlpsr' '-abn' '-lpcd' '-rbracks' '-mssp' '1cm' 'Chords_LOOP.xml'
% or, with long option names:
%  xml2ly Chords_LOOP.xml -xml2ly-infos -auto-output-file-name -display-msr -display-partgroups -display-lpsr -all-bar-numbers -lilypond-compile-date -repeat-brackets -markup-system-spacing.padding '1 cm'
% or, with short option names:
%   xml2ly Chords_LOOP.xml -xi -aofn -dmsr -dpg -dlpsr -abn -lpcd -rbracks -mssp '1 cm'
...
Part_POne_Staff_One_Voice_One = \absolute {
  ...
  \clef "treble"
  <c'' g'' e'' bes''! >8 -! -\p r%{2%}4 r%{2%}1.
  \cadenzaOff \undo \omit Staff.TimeSignature |
  
  \cadenzaOn \omit Staff.TimeSignature
  <a' c'' e'' a'' >2 -\f <b' d'' f'' > -\staccato -_
  \cadenzaOff \undo \omit Staff.TimeSignature |
}
