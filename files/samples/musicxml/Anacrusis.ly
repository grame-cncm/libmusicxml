...
% Generated by xml2ly 0.93 from "basic/Anacrusis.xml"
% on Sunday 2020-03-01 @ 08:57:46 CET

% The translation command line was:
%   xml2ly '-xi' '-aofn' '-dmsr' '-dpg' '--dlpsr' '-abn' '-lpcd' '-rbracks' '-mssp' '1cm' 'basic/Anacrusis.xml' '-loop'
% or, with long option names:
%  xml2ly basic/Anacrusis.xml -xml2ly-infos -auto-output-file-name -display-msr -display-partgroups -display-lpsr -all-bar-numbers -lilypond-compile-date -repeat-brackets -markup-system-spacing.padding '1 cm' -loop-to-musicxml
% or, with short option names:
%   xml2ly basic/Anacrusis.xml -xi -aofn -dmsr -dpg -dlpsr -abn -lpcd -rbracks -mssp '1 cm' -loop
