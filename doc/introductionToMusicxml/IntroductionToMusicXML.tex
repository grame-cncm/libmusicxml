...
Various applications handle \mxmlfile{lilypond-ignored/OverlappingPartGroups.xml} their own way. \xmlToLy\ rejects such data for the time being, with this message:
...
\mxml\ has rich support for metronome specifications. Example \mxmlfile{tempos/SwingTempo.xml} contains:\\
