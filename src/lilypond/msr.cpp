...
msrOptions::msrOptions ()
{
  ...
  fCatalanPitchName [k_eih]   = "eSemiSharp";
  ...
  // deutsch
  fDeutschPitchName [k_aSesquiFlat]  = "aSesquiFlat";
  ...
  fEnglishPitchName [k_desSemiFlat]    = = "dfqf";
