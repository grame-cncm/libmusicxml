...
msr2musicxmlVisitor::msr2musicxmlVisitor (
...
//________________________________________________________________________
void msr2musicxmlVisitor::printMusicXMLFromMsrScore (
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrScore& elt)
{
...
void msr2musicxmlVisitor::visitEnd (S_msrScore& elt)
{
  idtr--;
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrPartgroup& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
void msr2musicxmlVisitor::visitEnd (S_msrPartgroup& elt)
{
  idtr--;
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrPart& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
void msr2musicxmlVisitor::visitEnd (S_msrPart& elt)
{
  idtr--;
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrStaff& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
void msr2musicxmlVisitor::visitEnd (S_msrStaff& elt)
{
  idtr--;
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrVoice& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
void msr2musicxmlVisitor::visitEnd (S_msrVoice& elt)
{
  idtr--;
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrLyrics& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
void msr2musicxmlVisitor::visitEnd (S_msrLyrics& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrLyricschunk& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
void msr2musicxmlVisitor::visitEnd (S_msrLyricschunk& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrClef& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
void msr2musicxmlVisitor::visitEnd (S_msrClef& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrKey& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
void msr2musicxmlVisitor::visitEnd (S_msrKey& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrTime& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
void msr2musicxmlVisitor::visitEnd (S_msrTime& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrTempo& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
void msr2musicxmlVisitor::visitEnd (S_msrTempo& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrSequentialMusic& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
void msr2musicxmlVisitor::visitEnd (S_msrSequentialMusic& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrParallelMusic& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
void msr2musicxmlVisitor::visitEnd (S_msrParallelMusic& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrDuration& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
void msr2musicxmlVisitor::visitEnd (S_msrDuration& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrArticulation& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
void msr2musicxmlVisitor::visitEnd (S_msrArticulation& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrDynamics& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
void msr2musicxmlVisitor::visitEnd (S_msrDynamics& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrWedge& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
void msr2musicxmlVisitor::visitEnd (S_msrWedge& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrNote& elt)
{
  if (fMsrOptions->fDebug) {
    fOstream << idtr <<
      "--> Start visiting ";
...
void msr2musicxmlVisitor::visitEnd (S_msrNote& elt)
{
  if (fMsrOptions->fDebug) {
    fOstream << idtr <<
      "--> Start visiting ";
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrBeam& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
void msr2musicxmlVisitor::visitEnd (S_msrBeam& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrChord& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
void msr2musicxmlVisitor::visitEnd (S_msrChord& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrTuplet& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
void msr2musicxmlVisitor::visitEnd (S_msrTuplet& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrSlur& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
void msr2musicxmlVisitor::visitEnd (S_msrSlur& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrBarLine& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
void msr2musicxmlVisitor::visitEnd (S_msrBarLine& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrBarNumberCheck& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
void msr2musicxmlVisitor::visitEnd (S_msrBarNumberCheck& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrBreak& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
void msr2musicxmlVisitor::visitEnd (S_msrBreak& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrRepeat& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
void msr2musicxmlVisitor::visitEnd (S_msrRepeat& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrComment& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
void msr2musicxmlVisitor::visitEnd (S_msrComment& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrVarValAssoc& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
void msr2musicxmlVisitor::visitEnd (S_msrVarValAssoc& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrPaper& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrLayout& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
void msr2musicxmlVisitor::visitEnd (S_msrLayout& elt)
{
  idtr--;
...
//________________________________________________________________________
void msr2musicxmlVisitor::visitStart (S_msrMidi& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
...
void msr2musicxmlVisitor::visitEnd (S_msrMidi& elt)
{
  if (fMsrOptions->fDebug)
    fOstream << idtr <<
